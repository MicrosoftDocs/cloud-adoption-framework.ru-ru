...
- Настройте [базовые показатели удостоверений цепочки инструментов](./toolchain.md) на основе изменений в требованиях к изменению личности вашей организации.
...
- Убедитесь, что для учетных записей пользователей (Генерального директора, финансового директора, вице-президента и т. д.) всегда включено многофакторная идентификация и обнаружение аномальных входов
