...
- Рассмотрите возможность использования следующих моделей доступа:
  - Модель [административного доступа с минимальными правами](/windows-server/identity/ad-ds/plan/security-best-practices/implementing-least-privilege-administrative-models) доступа.
  - Модель доступа [Управление привилегированными пользователями](/azure/active-directory/privileged-identity-management/pim-configure) .
- Завершите все сведения о прединтеграции и ознакомьтесь с рекомендациями по [обеспечению безопасности управления удостоверениями и доступом](/azure/security/fundamentals/identity-management-best-practices).
  - Включить единый вход с одним удостоверением (SSO), также называемый простым ВХОДом в систему.
...
- Реализуйте интегрированный мониторинг, рекомендуемый [Центром безопасности Azure](/azure/security-center/security-center-introduction).
