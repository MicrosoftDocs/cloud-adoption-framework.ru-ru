...
На начальных этапах развития концепции команды по разработке приложений занимались разработкой и тестированием, а команда бизнес-аналитики все еще работала в экспериментальном режиме. Она работала в двух средах с размещенной инфраструктурой, которая называется «произ.» и «DR».
...
- Схема Azure.
    - Создайте новый проект с именем protected-Data.
    - Добавьте в проект шаблоны "брандмауэр", "Центр безопасности Azure" и "хранилище служб восстановления Azure".
