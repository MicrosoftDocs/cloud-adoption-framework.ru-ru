...
В этом разделе статьи будет изменен проект MVP по управлению для включения новых политик Azure и реализации службы управления затратами Azure и выставления счетов. Вместе эти изменения проекта будут удовлетворять новым корпоративным операторам политики.
...
4. Добавление ресурсов в службу управления затратами Azure и выставление счетов.
    1. Служба "Управление затратами Azure" и выставление счетов были разработаны с самого начала в качестве многооблачного средства.
