---
title: 'Комплексное корпоративное управление: улучшение в облаке'
description: Используйте платформу внедрения облачных технологий для Azure, чтобы узнать о нескольких облаках и интегрировать многооблачные Организации для сложных предприятий.
...
- Непрерывность бизнес-процессов и аварийное восстановление (BCDR) контролируются хранилищами служб восстановления Azure.
...
В этом разделе статьи улучшена структура MVP по управлению, которая включает новые политики Azure и реализацию службы управления затратами Azure и выставления счетов. Совокупно эти изменения проекта позволят внедрить новые правила корпоративной политики.
...
4. Добавление ресурсов в службу управления затратами Azure и выставление счетов.
    1. Служба управления затратами Azure и выставление счетов были созданы в виде многооблачного средства с самого начала.
    2. Виртуальные машины в дополнительном облаке могут быть совместимы с службой "Управление затратами Azure" и выставления счетов для некоторых поставщиков облачных служб. Может взиматься дополнительная плата.
...
Включение в составе облака должно содержаться в том месте, где они требуются, в соответствии с техническими потребностями или конкретными бизнес-требованиями. По мере роста многооблачного внедрения повышает сложность и риски безопасности.
