---
title: 'Комплексное корпоративное управление: Улучшенная дисциплина согласованности ресурсов'
...
1. Политика Azure для критически важных узлов:
    ...
    3. Выполните аудит и примените утвержденную подсеть виртуальной сети и виртуальную сеть для каждого сетевого интерфейса.
