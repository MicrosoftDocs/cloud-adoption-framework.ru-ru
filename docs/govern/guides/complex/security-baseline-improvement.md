...
1. Шаблон пиринга сети. Этот шаблон будет дорангировать виртуальную сеть в каждой подписке с помощью виртуальной сети Hub в корпоративной подписке.
    ...
    5. Служба автоматизации Azure требует дополнительной [настройки сети](https://docs.microsoft.com/azure/automation/automation-dsc-overview#network-planning) для применения DSC к размещенным виртуальным машинам.
