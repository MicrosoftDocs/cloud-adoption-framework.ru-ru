...
9. По возможности средства управления конфигурациями узлов должны применять требования политики к конфигурации любой гостевой операционной системы. Управление конфигурацией узла должно учитывать существующие инвестиции в объект групповой политики (GPO) для настройки ресурсов.
...
6. Интеграция объектов групповой политики (GPO) с помощью настройки требуемого состояния (DSC):
    ...
    2. Разверните конфигурацию состояния службы автоматизации Azure для всех экземпляров корпоративной подписки на ИТ. Службу автоматизации Azure можно использовать для применения DSC к виртуальным машинам, развернутым в поддерживаемых подписках в группе управления.
...
1. Шаблон пиринга сети. Этот шаблон будет дорангировать виртуальную сеть в каждой подписке с помощью виртуальной сети Hub в корпоративной подписке.
    ...
    5. Служба автоматизации Azure будет требовать дополнительной [настройки сети](https://docs.microsoft.com/azure/automation/automation-dsc-overview#network-planning) для применения DSC к размещенным виртуальным машинам.
