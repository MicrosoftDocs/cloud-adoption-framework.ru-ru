...
В этом разделе изменяется структура MVP по управлению, которая включает новые политики Azure и реализацию службы "Управление затратами Azure". Совокупно такие изменения проекта станут новыми положениями корпоративной политики.
...
1. Шаблон пиринга сети. Этот шаблон включит пиринговое подключение виртуальной сети в каждой подписке к виртуальной сети центрального узла в подписке на корпоративные ИТ-решения.
    ...
    4. VPN также следует удалить из этого шаблона, чтобы не пересылать трафик непосредственно в локальный центр обработки данных, не продавая через корпоративную ИТ-подписку и брандмауэр. Вы также можете задать эту VPN в качестве цепи отработки отказа в случае аутже канала ExpressRoute.
