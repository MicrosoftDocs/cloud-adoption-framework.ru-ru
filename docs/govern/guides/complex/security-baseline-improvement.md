...
3. Создание политик Azure. Создайте политику с именем `Hub NSG Enforcement` , чтобы принудительно настроить группу безопасности сети, назначенную любой виртуальной сети, созданной в этой подписке. Примените встроенные политики для гостевой конфигурации следующим образом:
...
4. Схема корпоративных ИТ-решений
    ...
    2. Добавьте центрально-и резервные `Hub NSG Enforcement` шаблоны и политику.
...
**Применение дополнительных систем управления к подписке на внедрение в облако (спица):** Разработка в соответствии `Corporate IT Subscription`с незначительными изменениями в MVP по управлению, применяемой к каждой подписке, выделенной для поддержки архетипов приложений, может привести к быстрому улучшению.
