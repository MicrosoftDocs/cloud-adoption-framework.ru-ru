...
> [!WARNING]
> Вам с самого начала может потребоваться более надежная система управления. В таких случаях следует рассмотреть возможности [целевой зоны CAF корпоративного уровня](../../ready/enterprise-scale/index.md). Подход на основе целевых зон CAF корпоративного уровня предназначен для команд по внедрению, цель которых — в средние сроки (в течение 24 месяцев) разместить более 1000 ресурсов (приложений, компонентов инфраструктуры или ресурсов данных) в облаке. Целевая зона CAF корпоративного уровня — это очевидное решение для реализации сложных систем управления, связанных с такими масштабными усилиями по внедрению облака.
...
|---|---|---|
| Управление затратами &mdash; учет облачных затрат | Модель виртуальных счетов. Счета выставляются централизованно через ИТ-подразделение. | Модель возвратных платежей. Счета могут выставляться через механизм ИТ-закупок. |
| Базовые средства безопасности &mdash; защищенные данные | Финансовые данные и интеллектуальная собственность компании. Некоторые клиентские данные. Отсутствуют внешние требования к обеспечению соответствия. | Много разных наборов финансовых и персональных данных клиентов. Могут быть внешние требования к обеспечению соответствия. |
...
Архитектура целевой зоны CAF корпоративного уровня предназначена решить эти задачи на ранних этапах жизненного цикла внедрения с помощью различных архитектур, реализаций и рекомендаций, которые помогут достичь баланса между требованиями команд по внедрению облака и центрального ИТ-отдела во время внедрения корпоративного облака. В основе этого подхода лежит принцип общей архитектуры служб и хорошо управляемых целевых зон.
...
Подход на основе [целевых зон CAF корпоративного уровня](../../ready/enterprise-scale/index.md) предназначен для команд по внедрению, цель которых — в средние сроки (в течение 24 месяцев) **разместить более 1000 ресурсов (приложений, компонентов инфраструктуры или ресурсов данных) в облаке**.
