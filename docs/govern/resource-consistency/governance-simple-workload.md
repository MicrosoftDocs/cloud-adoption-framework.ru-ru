...
![Глобальный администратор Azure AD создает учетную запись](../../_images/govern/design/governance-1-2.png)
...
![* * Владельцу рабочей нагрузки * * назначена роль](../../_images/govern/design/governance-1-6.png)
...
![* * Владелец рабочей нагрузки * * создает группу](../../_images/govern/design/governance-1-7.png)
...
Наконец, создав подписку и связав с нею клиент Azure AD, вы можете [добавить в нее **владельца рабочей нагрузки** со встроенной ролью **владельца**](https://docs.microsoft.com/azure/billing/billing-add-change-azure-subscription-administrator#assign-a-user-as-an-administrator-of-a-subscription).
