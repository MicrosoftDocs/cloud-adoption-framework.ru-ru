...
- Рассмотрите возможность развертывания [политики Azure](https://docs.microsoft.com/azure/governance/policy/overview) для управления принудительным применением соглашений об уровне обслуживания с помощью параметров конфигурации и правил создания ресурсов.
