...
Рекомендации по выбору оптимального шаблона мониторинга для развертывания см. в разделе [руководство по ведению журнала и составления отчетов](../../decision-guides/logging-and-reporting/index.md) для облачной инфраструктуры внедрения.
