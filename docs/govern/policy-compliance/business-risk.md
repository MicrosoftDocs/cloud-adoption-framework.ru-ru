...
Как правило, для определения наименьшей единицы чего-то, которая может подать материальную ценность, обычно используется **Минимальный подходящий продукт** . В MVP по бизнес-рискам группа управления облаком начинает с предположения, что некоторые ресурсы будут развернуты в облачной среде в определенный момент времени. Это неизвестное количество ресурсов, и группа может быть неточной, какие типы данных будут храниться в этих ресурсах.
