...
description: Классификация данных позволяет определять и назначать данные вашей организации, а также является общей отправной точкой для управления.
