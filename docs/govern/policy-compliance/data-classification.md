...
description: Используйте классификацию данных в качестве отправной точки для управления облаком путем определения и назначения ценности для данных Организации.
