...
ms.locfileid: "101789309"
---
# <a name="security-baseline-discipline-template"></a>Шаблон дисциплины "Основные способы защиты"

Первым шагом для реализации изменений является взаимодействие с нужным. То же самое касается изменения рекомендаций системы управления. Следующий шаблон предоставляет отправную точку для документирования и обмена инструкциями политики, которые управляют вопросами, связанными с безопасностью в облаке.
