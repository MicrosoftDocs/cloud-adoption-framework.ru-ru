...
> [!NOTE]
> Корпорация Майкрософт не имеет права диктовать корпоративную или ИТ-политику. Эта статья поможет вам подготовиться к проверке внутренней политики. Предполагается, что этот пример политики будет расширен, проверен и протестирован в соответствии с корпоративной политикой, прежде чем пытаться использовать ее. Использовать этот пример политики "как есть" не рекомендуется.

## <a name="policy-alignment"></a>Сопоставление политики

Этот пример политики синтезирован в собственном облаке, что означает, что средства и платформы, предоставляемые Azure, достаточно для управления бизнес-рисками, участвующими в развертывании. В этом сценарии предполагается, что простая конфигурация служб Azure по умолчанию обеспечивает достаточную защиту ресурсов.
...
Даже с этой вложенностью в облачной системе безопасности в собственном плане рекомендуется, чтобы все базовые политики безопасности были расширены по умолчанию собственными облачными политиками. Ниже приведены примеры расширенных политик, которые следует учитывать даже в облачной среде.
