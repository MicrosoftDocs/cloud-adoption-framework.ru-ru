...
Идентификация становится новым уровнем управления границами безопасности, взятым из традиционной сетевой инфраструктуры. Периметр сети становится все более проницаемымным, и защита периметра не может быть такой же, как и до появления приложений с собственным устройством (BYOD) и облачными приложениями. Управление удостоверениями и доступом Azure обеспечивает простой и безопасный доступ ко всем приложениям.
