...
Прежде чем вносить изменения в архитектуру, ознакомьтесь с техническим руководителем рабочей нагрузки. Упрощение проверки рабочей нагрузки с помощью [проверки архитектуры Azure](https://docs.microsoft.com/assessments/?id=azure-architecture-review) и [платформы архитектуры Azure](https://docs.microsoft.com/azure/architecture/framework) для решения вопросов, касающихся следующих типов архитектурных изменений.
...
| **Файла** | Управляемые общие файловые ресурсы, доступ к которым осуществляется через SMB 3,0. | Используется при переносе локальных файловых ресурсов и для предоставления нескольких прав доступа и подключений к данным файлов. |
