...
- **Очистите**о причинах: почему мы принимаем облако?
- **Определенные бизнес-результаты**: какие результаты мы хотим увидеть из внедрения облака?
- **Коммерческое обоснование**: как будет выполнена оценка бизнес-мер?
...
- **Готовность навыков**: сколько людей выделяется для выполнения необходимых задач? Насколько хорошо эти навыки относятся к усилиям по внедрению в облако? Согласованы ли партнеры для поддержки технической реализации?
