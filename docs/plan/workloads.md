---
title: Определение приоритетов и определение рабочих нагрузок для внедрения в облако
description: Используйте платформу внедрения облачных технологий для Azure, чтобы узнать, как определять приоритеты и определить рабочие нагрузки для плана внедрения в облако.
