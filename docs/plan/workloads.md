---
title: Определение приоритетов и определение рабочих нагрузок для плана внедрения в облако
titleSuffix: Microsoft Cloud Adoption Framework for Azure
description: Определение приоритетов и определение рабочих нагрузок для плана внедрения в облако
...
Стратегические входные данные из контрольного списка необходимых компонентов позволяют значительно упростить выполнение следующих задач. Чтобы получить справку по сбору данных, обсуждаемых в этой статье, ознакомьтесь с [контрольным списком предварительных требований](./prerequisites.md).

## <a name="initial-workload-prioritization"></a>Приоритет начальной рабочей нагрузки

В процессе инкрементного [рационализации](../digital-estate/rationalize.md)ваша команда должна согласиться на подход "мощность 10", который состоит из 10 рабочих нагрузок с приоритетом. Эти рабочие нагрузки служат начальной границей для планирования внедрения.
...
> [!NOTE]
> Сила 10 выступает в качестве начальной границы для планирования, чтобы сконцентрировать энергию и инвестиции на ранних стадиях анализа. Однако процесс анализа и определения рабочих нагрузок, скорее всего, приведет к изменениям в списке приоритетных рабочих нагрузок.
...
| metrics | Какие метрики будут использоваться для наблюдения за успешным выполнением? |         |
| Соответствие | Существуют ли какие-либо требования к совместимости сторонних производителей для этой рабочей нагрузки? |         |
...
| География | Затронуты ли эти рабочие нагрузки? |         |
