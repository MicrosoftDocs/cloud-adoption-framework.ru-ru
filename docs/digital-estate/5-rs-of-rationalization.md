...
- **Миф. решения по рациональному обоснованию можно легко выполнить на ранних этапах процесса.** Точная рационализация требует глубокого знания рабочей нагрузки и связанных ресурсов (приложений, виртуальных машин и данных). Самое важное, точное решение по рациональному обоснованию занимает время. Рекомендуется использовать [процесс инкрементного рационализации](./rationalize.md#incremental-rationalization).
