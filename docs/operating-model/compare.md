...
| **Целевая зона** | Недоступно | Высокая сложность | От средней до низкой сложности | Низкая сложность |
| **Основные служебные программы** | Недоступно | Н/д или низкая поддержка | Централизованная и дополнительная поддержка | Большинство поддерживаемых |
