...
ms.locfileid: "88575965"
---
# <a name="compare-common-cloud-operating-models"></a>Сравнение общих рабочих моделей в облаке
...
Как описано в разделе [Определение операционной модели](./define.md), каждая методология в инфраструктуре внедрения облаков предоставляет структурированный путь для итеративной разработки каждого аспекта вашей операционной модели. С помощью наиболее актуальной методологии вы сможете преодолеть блокировку, которая повлечет за собой зазоры в облачной операционной модели.
...
> [!div class="nextstepaction"]
> [Сравнение общих рабочих моделей в облаке](../ready/landing-zone/index.md)
