...
Внедрение облачных технологий — это то, _что мы делаем_ для реализации ценности бизнеса. Операционная модель представляет _, кто мы_ и как ежедневно работает в процессе внедрения облака.
