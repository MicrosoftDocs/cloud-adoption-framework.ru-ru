...
Обратите внимание, что использование слова _Trust_ в безопасности может быть запутанным. Эта документация называется двумя способами, иллюстрирующими полезные приложения этой концепции:
