...
description: Обнаружение стратегий балансировки конкурирующих приоритетов
...
ms.locfileid: "79312415"
---
# <a name="balance-competing-priorities"></a>Балансировка приоритетов конкурирующих задач

Начинать в любом пути цифрового преобразования действует как форсированная функция для заинтересованных лиц, в рамках бизнес-и технологических групп. Путь к успешному выполнению надежно направляется в Организации для балансировки конкурирующих приоритетов.
...
Основная цель методологии стратегии заключается в разработке выравнивания среди заинтересованных лиц. После определения в соответствии с этим стратегическим положением поведение будет использоваться в каждой методологии, чтобы обеспечить соответствие технических решений желаемым результатам бизнеса. С помощью согласования между заинтересованными лицами создаются стандартные приоритеты для конкурирующих **элементов: глубина обоснования** и **время на бизнес-последствия**.
...
- **Время до воздействия на бизнес**: и наоборот, заинтересованные лица часто удерживаются для предоставления результатов бизнеса в пределах определенных временных интервалов. Длительный анализ и оценка могут поставить результаты на риск до начала технической работы.
...
Во время миграции разработчики часто предполагают, что рабочие нагрузки будут переноситься в облако в соответствии с текущей конфигурацией "как есть". Это напрямую конкурирует с прямым представлением для перенаправления каждой рабочей нагрузки, чтобы лучше использовать облачные возможности. Увы, эти два не являются взаимоисключающими и могут быть бесплатными при управлении через общий процесс.
...
- Широкие инвестиции: инвестиции в непростое, быстрое восстановление и мониторинг в среде являются традиционным представлением управления операциями. Этот подход может быть дорогостоящим и иногда дублированием вспомогательных продуктов, предоставляемых поставщиком облачных решений.
- Без операций и небольших операций. Используйте собственные средства работы с облаком, чтобы сокращать повторяющиеся и повторяющиеся задачи, ранее доставленные сотрудниками с полным временем. Уменьшение этих функциональных зависимостей в модели управления операциями освобождает сотрудников от того, чтобы увеличить ценность. Этот подход может привести к поддержке субпар операций.
...
**Пример развернутой области:** В большинстве сред небольшой процент рабочих нагрузок, бизнес-ценность которых обстоит тщательные инвестиции в операции. В этих сценариях ИТ – группа может захотеть использовать проверку архитектуры Azure и платформу архитектуры Azure для более глубокого выполнения операций.
