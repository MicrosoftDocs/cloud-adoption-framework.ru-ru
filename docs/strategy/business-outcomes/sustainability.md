...
Платформа Интернета вещей [бüхлер](https://customers.microsoft.com/story/730776-buhler-group-consumer-goods-azure-iot-germany), известная как бüхлер Insights и на базе центра Интернета вещей Azure, создает важные данные, чтобы клиенты могли отслеживать производительность компьютера и создавать точные записи для каждого пакета продукта, помогая производителям продуктов повысить безопасность, устойчивость и прозрачность в цепочке поставок.
...
**Шаг 3.** Создайте стимул для групп, чтобы сократить выбросы углерода. [Плата за аннулирование корпорации Майкрософт. теоретические и практические рекомендации](https://download.microsoft.com/documents/en-us/csr/environment/microsoft_carbon_fee_guide.pdf) помогут вашей организации в обеспечении согласованности и отчетности в группах.
