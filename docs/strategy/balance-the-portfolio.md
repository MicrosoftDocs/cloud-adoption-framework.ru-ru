...
| Результат  | Измерение  | Goal  | Интервал времени  | Приоритет действия  |
|---------|---------|---------|---------|---------|
...
Если ответ на оба этих вопроса равен «Да», то было бы разумно _не_ переносить рабочую нагрузку. Этот подход поможет достичь целей снижения затрат и ухода из центра обработки данных.
