...
description: Осознайте важность согласованности облачных ресурсов и изучите факторы, которые определяют требования к согласованности ресурсов.
author: doodlemania2
ms.author: dermar
ms.date: 10/17/2019
ms.topic: guide
