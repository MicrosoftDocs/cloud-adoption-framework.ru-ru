...
> [!IMPORTANT]
> Группы ресурсов также привязаны к региону, но очень часто ресурсы могут находиться в разных регионах, но в одной группе ресурсов. Это становится возможным благодаря тому, что они управляются в комплексе, как описано выше. См. сведения о [выборе регионов](../../migrate/azure-best-practices/multiple-regions.md).
