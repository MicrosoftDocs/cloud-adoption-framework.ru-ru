...
| Применяются ли в вашей организации правила или политики, запрещающее хранение ключей вне организации?                | Нет           | Нет     | Yes         |
...
Для шифрования передаваемых данных для трафика обычно принудительно применяются протоколы SSL/TLS. Транзитный трафик между размещенными в облаке ресурсами и внешней сетью или общедоступным Интернетом всегда должен шифроваться. Ресурсы PaaS обычно по умолчанию требуют для трафика шифрование SSL/TLS. Ответственность за решение вопроса о применении шифрования для трафика между ресурсами IaaS, размещенными внутри виртуальных сетей, лежит на специалистах по внедрению облака и на владельцах рабочих нагрузок. В общем случае мы рекомендуем применять шифрование.
