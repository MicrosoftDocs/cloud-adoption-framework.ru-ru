...
Передаваемыми называются данные, которые перемещаются между ресурсами во внутренней сети, между центрами обработки данных или внешними сетями, а также через Интернет.
