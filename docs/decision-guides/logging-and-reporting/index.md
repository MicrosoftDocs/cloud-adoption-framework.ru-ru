...
Существует несколько способов ведения журналов и создания отчетов о действиях в облаке. Полностью облачное и централизованное ведение журналов — это два распространенных варианта управляемых служб, выбор между которыми определяется структурой и числом подписок.
