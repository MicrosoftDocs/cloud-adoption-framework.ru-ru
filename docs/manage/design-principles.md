...
В качестве дополнения к этой платформе [Microsoft Azure Well-Architected Framework](/azure/architecture/framework) предоставляет основные принципы для повышения качества платформы или конкретной рабочей нагрузки. Эта платформа сосредоточена на улучшении в пяти базовых принципах работы архитектуры:
...
Чтобы улучшить структуру системы, ознакомьтесь с дополнительными сведениями о [Microsoft Azure Well-Architected Framework](/azure/architecture/framework). По мере улучшения структуры системы вернитесь к этой статье, чтобы найти новые возможности по улучшению и масштабированию улучшений в среде.
...
### <a name="continuous-improvement"></a>Постоянное совершенствование
