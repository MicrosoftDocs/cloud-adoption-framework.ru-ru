...
Сведения о публикации в каталоге услуг см. в серии, посвященной [публикации в каталоге услуг](/azure/azure-resource-manager/managed-applications/publish-service-catalog-app).
...
- [Azure Monitor for containers overview](/azure/azure-monitor/containers/container-insights-overview) (Обзор Azure Monitor для контейнеров)
