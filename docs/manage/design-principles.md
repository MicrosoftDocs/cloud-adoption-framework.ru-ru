...
В качестве дополнения к этой инфраструктуре [Microsoft Azure хорошо спроектированная платформа](https://docs.microsoft.com/azure/architecture/framework) предоставляет основные принципы для повышения качества платформы или конкретной рабочей нагрузки. Эта платформа сосредоточена на улучшении в пяти базовых принципах работы архитектуры:

- **Оптимизация затрат:** Управляйте затратами, чтобы максимально увеличить доставленное значение.
- **Эффективное эксплуатация:** Поддерживайте операционные процессы, которые сохраняют систему в рабочей среде.
- **Эффективность производительности:** Масштабирование систем для адаптации к изменениям нагрузки.
- **Надежность:** Разработайте системы для восстановления после сбоев и продолжения работы.
- **Безопасность:** Защитите приложения и данные от угроз.
...
Чтобы улучшить структуру системы, Узнайте больше о [Microsoft Azure хорошо спроектированной инфраструктурой](https://docs.microsoft.com/azure/architecture/framework). По мере улучшения структуры системы вернитесь к этой статье, чтобы найти новые возможности по улучшению и масштабированию улучшений в среде.
