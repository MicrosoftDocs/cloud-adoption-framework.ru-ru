...
- **Улучшение проектирования системы**. Повысьте эффективность разработки общих систем (платформ) или конкретных рабочих нагрузок, чтобы уменьшить количество прерываний.
- **Автоматизация исправления**. Некоторые улучшения не являются экономичными. В таких случаях может оказаться разумным автоматизировать исправление и снизить влияние прерываний.
- **Масштабирование решения**. в процессе улучшения разработки и автоматического исправления можно масштабировать эти изменения в среде через каталог услуг.
...
- **Масштабируемость**. масштабирование общих ресурсов платформы для повышения нагрузки.
- **Доступность**: уменьшение количества бизнес-прерываний за счет повышения времени бесперебойной работы.
...
- **Управление**: операции, характерные для этих общих ресурсов платформы.
