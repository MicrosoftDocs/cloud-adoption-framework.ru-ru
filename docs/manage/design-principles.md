...
Улучшение проектирования системы — это самый эффективный подход к улучшению операций любой распространенной платформы. Улучшения в разработке системы могут способствовать повышению стабильности и снижению количества бизнес-прерываний. Структура отдельных систем выходит за рамки представления среды, рассматриваемого в рамках Cloud Adoption Framework. В качестве дополнения к этой платформе Microsoft Azure хорошо спроектированная инфраструктура предоставляет рекомендации по повышению устойчивости и проектированию конкретной системы. Эти улучшения проектирования можно применить к системным структурам платформы или конкретной рабочей нагрузке.

Microsoft Azure хорошо спроектированная инфраструктура сосредоточена на усовершенствованиях в пяти основных аспектах проектирования системы:
...
Чтобы улучшить структуру системы, Узнайте больше о [Microsoft Azure хорошо спроектированной инфраструктурой](https://docs.microsoft.com/azure/architecture/guide/pillars). По мере улучшения структуры системы вернитесь к этой статье, чтобы найти новые возможности по улучшению и масштабированию улучшений в среде.
