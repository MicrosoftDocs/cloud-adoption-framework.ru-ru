...
- [Microsoft Azure хорошо спроектированная платформа](/azure/architecture/framework): Узнайте о принципах использования GUID для повышения качества рабочей нагрузки. Платформа состоит из пяти основных компонентов качественной архитектуры:
  - Оптимизация затрат
  - эффективность работы;
  - оптимизация производительности;
  - надежность;
  - Безопасность
- [Десять принципов проектирования для приложений Azure](/azure/architecture/guide/design-principles).
...
- [Шаблоны облачного проектирования](/azure/architecture/patterns).
