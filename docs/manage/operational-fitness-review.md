...
- **Бизнес-владелец**: предоставляет знания о бизнесе для определения и приоритизации каждой критически важной бизнес-операции. Эта роль также сравнивает затраты на снижение рисков с влиянием на бизнес и устраняет окончательное решение об исправлении.

- **Бизнес-обоснованный**: разбивает бизнес-операции на части скрытые и сопоставляет их с службами и инфраструктурой, будь то локальная или облачная. Этот сотрудник должен обладать глубоким пониманием используемых технологий по каждой бизнес-операции.
