...
|---|---|---|
| Требования к инфраструктуре | нет | Да <br><br> Требуется, как минимум, сервер управления и экземпляр SQL Server для размещения рабочей базы данных и базы данных хранилище данных отчетов. Сложность возрастает, когда требуется высокая доступность и аварийное восстановление, а также есть компьютеры в нескольких сайтах, ненадежных системах и другие сложные вопросы проектирования. |
...
Вы также можете добиться целостного мониторинга с помощью сочетания [возможностей мониторинга инфраструктуры](/azure-stack/operator/azure-stack-monitor-health) , которые включены в Azure Stack. Эти возможности помогают просматривать работоспособность и оповещения для Azure Stack региона и [службы Azure Monitor](/azure-stack/user/azure-stack-metrics-azure-data) в Azure Stack, которая предоставляет метрики и журналы инфраструктуры базового уровня для большинства служб.
