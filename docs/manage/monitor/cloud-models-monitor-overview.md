...
В настоящее время этот раздел находится на стадии разработки, чтобы предоставить исчерпывающий набор рекомендаций для этой облачной модели и скоро станет доступным.  
