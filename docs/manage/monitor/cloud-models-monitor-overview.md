...
|---|---|---|---|
| Развертывание | Веб-приложение, работающее на платформе .NET, .NET Core, Java, JavaScript и Node. js на виртуальной машине Azure, службе приложений Azure, Service Fabric Azure, функциях Azure и облачных службах Azure. | Отслеживайте активное веб-приложение для автоматического обнаружения аномалий производительности, выявления исключений и проблем с кодом, а затем собирайте аналитику поведения пользователей. |  Application Insights (функция Azure Monitor). |
...
| Подписка Azure | Работоспособность службы Azure и основная работоспособность ресурсов. | <li> Административные действия, выполняемые в службе или ресурсе. <li> Работоспособность службы в службе Azure находится в состоянии пониженной работоспособности или недоступности. <li> Проблемы работоспособности, обнаруженные ресурсом Azure с точки зрения службы Azure. <li> Операции, выполняемые с помощью автомасштабирования Azure, указывают на ошибку или исключение. <li> Операции, выполняемые с помощью политики Azure, указывающие на то, что произошло разрешенное или отклоненное действие. <li> Запись предупреждений, созданных центром безопасности Azure. | Доставляется в журнал действий для мониторинга и оповещений с помощью Azure Resource Manager. |
...
| Мониторинг Azure PaaS | Да | Да, ограничено <br><br> В зависимости от поддерживаемых возможностей пакета управления Azure. |
| Мониторинг служб Azure | Да | Да <br><br> Хотя нет собственного мониторинга работоспособности служб Azure в настоящее время с помощью пакета управления, вы можете создавать настраиваемые рабочие процессы для запроса оповещений о работоспособности служб Azure. Используйте REST API Azure для получения оповещений через существующие уведомления. |
| Мониторинг современного веб-приложения | Да | Нет |
| Устаревший мониторинг веб-приложений | Да, ограничено, зависит от пакета SDK <br><br> Поддерживает мониторинг старых версий веб-приложений .NET и Java. | Да, ограничено |
| Мониторинг контейнеров службы Kubernetes Azure | Да | Нет |
| Мониторинг контейнеров DOCKER или Windows | Да | Нет |
| Мониторинг производительности сети | Да | Да, ограничено <br><br> Поддерживает проверки доступности и собирает основные статистические данные с сетевых устройств с помощью протокола SNMP из корпоративной сети. |
| Интерактивный анализ данных | Да | Нет <br><br> Полагается на SQL Server Reporting Services предустановленные или пользовательские отчеты, решения для визуализации сторонних производителей или пользовательскую реализацию Power BI. В хранилище данных Operations Manager существуют ограничения масштабирования и производительности. Интегрируйтесь с журналами Azure Monitor в качестве альтернативы требованиям к агрегированию данных. Интеграция достигается путем настройки соединителя Log Analytics. |
| Комплексная диагностика, анализ основных причин и своевременное устранение неполадок | Да | Да, ограничено <br><br> Поддерживает сквозную диагностику и устранение неполадок только для локальной инфраструктуры и приложений. Использует другие компоненты System Center или партнерские решения. |
| Интерактивные визуализации (панели мониторинга) | Да | Да, ограничено <br><br> Предоставляет ценные панели мониторинга с веб-консолью HTML5 или опытные решения для партнеров, таких как квадраты и Сависион. |
