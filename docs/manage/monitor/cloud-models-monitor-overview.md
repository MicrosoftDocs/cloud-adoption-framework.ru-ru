...
|---|---|---|---|
| Приложение | Веб-приложение, работающее на .NET, .NET Core, Java, JavaScript и Node.js платформе на виртуальной машине Azure, службе приложений Azure, Service Fabric Azure, функциях Azure и облачных службах Azure. | Отслеживайте активное веб-приложение для автоматического обнаружения аномалий производительности, выявления исключений и проблем с кодом, а затем собирайте аналитику поведения пользователей. |  Application Insights (функция Azure Monitor). |
