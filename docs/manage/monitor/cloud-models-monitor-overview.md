...
ms.openlocfilehash: 1ad15b56f268791b86886d0e2667475231ea8eb6
ms.sourcegitcommit: bcc73d194c6d00c16ae2e3c7fb2453ac7dbf2526
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/09/2020
ms.locfileid: "86193105"
---
...
|---|---|---|---|
| Приложения | Веб-приложение, работающее на .NET, .NET Core, Java, JavaScript и Node.js платформе на виртуальной машине Azure, службе приложений Azure, Service Fabric Azure, функциях Azure и облачных службах Azure. | Отслеживайте активное веб-приложение для автоматического обнаружения аномалий производительности, выявления исключений и проблем с кодом, а затем собирайте аналитику поведения пользователей. | Application Insights (функция Azure Monitor). |
...
| Тест доступности веб-приложения (изолированная сеть) | Да, ограничено <br><br> Azure Monitor имеет ограниченную поддержку в этой области и требует особых исключений брандмауэра. | Да |
| Проверка доступности веб-приложения (глобально распределенная) | Нет | Да |
| Мониторинг рабочих нагрузок виртуальных машин | Да, ограничено <br><br> Может выполнять получение сведений о службах IIS и SQL Server журналах ошибок, событиях Windows и счетчиках производительности. Требует создания пользовательских запросов, предупреждений и визуализаций. | Да <br><br> Поддерживает мониторинг большинства рабочих нагрузок сервера с помощью доступных пакетов управления. Требуется агент Log Analytics Windows или агент Operations Manager на виртуальной машине, передающий управление в группу управления в корпоративной сети. |
| Мониторинг Azure IaaS | Да | Да <br><br> Поддерживает мониторинг большей части инфраструктуры из корпоративной сети. Отслеживает состояние доступности, метрики и оповещения для виртуальных машин Azure, SQL и хранилища с помощью пакета управления Azure. |
