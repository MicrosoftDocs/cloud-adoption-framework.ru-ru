...
| Мониторинг служб Azure | Да | Да <br><br> Хотя нет собственного мониторинга работоспособности служб Azure, предоставленных сегодня через пакет управления, можно создавать пользовательские рабочие процессы для запроса оповещений о работоспособности службы. Используйте REST API Azure для получения оповещений через существующие уведомления. |
