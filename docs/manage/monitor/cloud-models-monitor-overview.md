...
| Ресурсы Azure — инфраструктура как услуга (IaaS) | 1. Служба хранилища Azure <br> 2. [службы балансировки нагрузки](/azure/architecture/guide/technology-choices/load-balancing-overview#azure-load-balancing-services) Azure <br> 3. группы безопасности сети <br> 4. виртуальные машины Azure <br> 5. [Azure Kubernetes Service](/azure/aks/intro-kubernetes) / [экземпляры контейнеров Azure](/azure/container-instances/) Kubernetes Service | 1. емкость, доступность и производительность. <br> 2. журналы производительности и диагностики (активность, доступ, производительность и брандмауэр). <br> 3. наблюдение за событиями при применении правил и Счетчик правил, определяющих количество случаев применения правила для запрета или разрешения. <br> 4. мониторинг емкости, доступности и производительности в операционной системе гостевой виртуальной машины (ОС). Сопоставьте зависимости приложений, размещенные на каждой виртуальной машине, включая видимость активных сетевых подключений между серверами, задержкой входящего и исходящего подключения и портами в любой архитектуре, подключенной по протоколу TCP. <br> 5. мониторинг емкости, доступности и производительности рабочих нагрузок, выполняемых в контейнерах и экземплярах контейнеров. | Для элементов с 1 по 5 в первом столбце метрики платформы и журнал действий автоматически собираются и доступны в Azure Monitor для анализа и оповещений. <br> Настройте параметры диагностики для пересылки журналов ресурсов в Azure Monitor журналы. <br> 4. Включите [Azure Monitor для виртуальных машин](/azure/azure-monitor/insights/vminsights-overview). <br> 5. Включите [Azure Monitor для контейнеров](/azure/azure-monitor/insights/container-insights-overview). |
...
- Используйте [дугу Azure](/azure-arc/overview) для подготовки серверов, виртуальных машин, кластеров Kubernetes и баз данных в среде для управления, как если бы они выполнялись в Azure. Служба "Дуга Azure" обеспечивает единообразную инвентаризацию, управление и безопасность с помощью привычных служб и возможностей управления Azure.
