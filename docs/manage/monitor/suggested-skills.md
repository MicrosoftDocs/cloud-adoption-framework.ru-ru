...
- Общие сведения о [интерфейсе командной строки Azure (CLI)](/cli/azure/get-started-with-azure-cli), который представляет собой возможности командной строки для управления ресурсами Azure на разных платформах. Также ознакомьтесь с введением в [Azure PowerShell](/powershell/azure/). В рамках обучающего курса [обучения средства управления Azure](https://www.linkedin.com/learning/learning-azure-management-tools), LinkedIn предлагают сеансы, охватывающие Azure CLI и языки программирования PowerShell:
...
- Сведения о планировании и проектировании развертываний мониторинга в масштабе и автоматизации действий путем просмотра [Azure Monitor рекомендаций и рекомендаций](https://www.youtube.com/watch?v=IWkqqahX_Ck&list=PLLasX02E8BPCDMuesOy2C0_TMFsoZWe_0&index=6).
...
- [Мониторинг Microsoft Azure гибридные облачные сети](https://www.pluralsight.com/courses/microsoft-azure-hybrid-cloud-networks-monitoring) — это расширенный курс, который поможет вам узнать, как использовать средства мониторинга Azure для визуализации, обслуживания и оптимизации виртуальных сетей и подключений виртуальных частных сетей для реализации гибридного облака.

- С помощью [дуги Azure для серверов](/azure/azure-arc/servers/overview)вы узнаете, как управлять компьютерами под управлением Windows и Linux, размещенными за пределами Azure, аналогично управлению виртуальными машинами, работающими в Azure.

- [Мониторинг виртуальных машин](https://www.youtube.com/watch?v=O7scXPrsM_0&list=PLLasX02E8BPCDMuesOy2C0_TMFsoZWe_0&index=6&t=0s) предоставляет подробные сведения о мониторинге гибридных компьютеров и серверов, а также виртуальных машинах Azure или масштабируемых наборов виртуальных машин с Azure Monitor для виртуальных машин.

## <a name="application-monitoring"></a>Мониторинг приложений

- Узнайте, как [Azure Monitor](/azure/azure-monitor/overview) помогает просматривать доступность и производительность приложений и служб вместе в одном месте. Pluralsight предлагает следующие курсы, которые помогут вам:
...
Ознакомьтесь со следующими сведениями, чтобы узнать об обновлениях, внесенных в наиболее популярную ITSM Framework [ITIL 4 и в облачной](https://www.axelos.com/case-studies-and-white-papers/itil-4-and-the-cloud)документации, которая посвящена присоединению существующих руководств по ITIL с рекомендациями от DevOps, Agile и экономичных подходов. Также рассмотрим [эталонную архитектуру IT4IT](https://www.opengroup.org/it4it) , которая предоставляет альтернативную схему для преобразования ее с помощью независимой от процесса платформы.
