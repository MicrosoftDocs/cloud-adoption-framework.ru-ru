...
- [Оповещение метрики](https://docs.microsoft.com/azure/azure-monitor/platform/alerts-metric). оповещения о данных метрик в Azure Monitor. Оповещения возникают, когда наблюдаемое значение пересекается с заданным пользователем пороговым значением, а затем снова возвращается в состояние "нормальное".

- [Предупреждение о запросе журнала](https://docs.microsoft.com/azure/azure-monitor/platform/alerts-log-query): доступно для оповещения о данных журнала из Application Insights или журналов Azure Monitor. Он также может получать оповещения на основе запросов между рабочими областями.

- [Оповещение журнала действий](https://docs.microsoft.com/azure/azure-monitor/platform/alerts-activity-log). оповещения об элементах в журнале действий за исключением данных о работоспособности службы Azure.
