...
1. В портал Azure откройте **все службы** и выберите **Управление** ,  > **решения**.
2. В представлении **решения** выберите **Добавить**.
3. Найдите и выберите **оценку защиты от вредоносных программ**.
4. Нажмите кнопку **Создать**.
