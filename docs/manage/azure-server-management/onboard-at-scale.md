...
- Развертывание агентов служб на серверах
- Включение решений по управлению
...
1. Развертывание необходимых агентов на локальных серверах
...
Чтобы охватить существующие серверы, а также будущие серверы, необходимо удалить конфигурацию области. Для этого просмотрите учетную запись службы автоматизации в портал Azure. Выберите **Управление обновлениями** > **Управление компьютером** > **включить на всех доступных и будущих компьютерах**. Этот параметр позволяет использовать Управление обновлениями всем виртуальным машинам Azure, подключенным к рабочей области.
...
1. В портал Azure откройте **все службы**, а затем выберите **Управление** > **решения**.
...
1. В портал Azure откройте **все службы**, выберите пункт **Управление и** > **решения**.
2. В представлении **решения** выберите **Добавить**.
...
Мы рекомендуем подключать все серверы по крайней мере к центру безопасности Azure уровня " *бесплатный* ". Этот вариант обеспечивает базовый уровень оценки безопасности и рекомендации по обеспечению безопасности для вашей среды. При обновлении до уровня " *стандартный* " вы получаете дополнительные преимущества, которые подробно обсуждаются на [странице цен на центр безопасности](https://docs.microsoft.com/azure/security-center/security-center-pricing).
...
2. В разделе **политика &AMP; соответствие**выберите **Политика безопасности**.
