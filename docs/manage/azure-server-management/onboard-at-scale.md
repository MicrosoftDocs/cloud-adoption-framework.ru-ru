...
1. Нажмите кнопку **Сохранить**. По умолчанию конфигурация области связана с сохраненным поиском **микрософтдефаулткомпутерграуп** . Он будет автоматически обновлен.
