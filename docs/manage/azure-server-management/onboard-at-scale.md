...
1. В портал Azure перейдите к **политике Azure** > **назначения** > **назначить инициативу**.
...
1. В портал Azure откройте **все службы** и выберите **управление** **решениями** > .
