...
Дополнительные рекомендации, такие как [Microsoft Azure Well-Architected Framework](/azure/architecture/framework/), могут помочь в принятии подробных архитектурных решений о каждой рабочей нагрузке в ранее описанных дисциплинах.
