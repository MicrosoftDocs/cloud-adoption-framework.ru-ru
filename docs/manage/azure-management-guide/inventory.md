...
|Инвентаризация и отслеживание изменений виртуальной машины|Служба отслеживания изменений и инвентаризации Azure|Инвентаризация виртуальных машин и мониторинг изменений на уровне гостевой ОС|
|Работоспособность служб|Журнал действий Azure|Мониторинг изменений на уровне подписки|
...
Каждая статья поможет вам выполнить ряд действий по подключению следующих решений:
...
Каждая из приведенных выше статей поможет настроить инвентаризацию и визуальный контроль.
