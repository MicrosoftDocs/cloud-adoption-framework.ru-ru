...
| Соответствие операций нормативным требованиям | Автоматизация гостевых систем |  Настройка требуемого состояния (DSC) | Настройка гостевых операционных систем на основе кода для сокращения ошибок и отклонения параметров конфигурации. | [Обзор DSC](/powershell/scripting/dsc/overview/overview) |
