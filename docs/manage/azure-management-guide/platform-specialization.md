...
Как дополнение к Cloud Adoption Framework, Microsoft Azure Well-Architected Framework предоставляет рекомендации по повышению устойчивости и улучшению проектирования определенной системы. Эти улучшения проектирования можно применить к системным структурам платформы или конкретной рабочей нагрузке.

Решение Microsoft Azure Well-Architected Framework ориентировано на усовершенствования в пяти основных аспектах проектирования систем:
...
Ознакомьтесь с дополнительными сведениями о [Microsoft Azure Well-Architected Framework](https://docs.microsoft.com/azure/architecture/guide/pillars) для улучшения проектирования систем.
