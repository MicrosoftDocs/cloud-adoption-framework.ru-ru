...
![Обзор процесса для проверки готовности к эксплуатации](_images/ofr-flow.png)
...
- **Владелец компании**: Предоставляет сведения о бизнесе для определения и приоритизации каждой критически важной бизнес-операции. Также этот сотрудник сравнивает стоимость устранения рисков с влиянием на коммерческую деятельность, принимая окончательное решение по применению мер устранения.
