...
> [!NOTE]
> ИТ-руководители никогда не должны вносить изменения в организационную диаграмму. Они также должны проверять и анализировать отзывы от каждой из поддерживаемых групп. Но преобразованияные усилия, такие как принятие в облаке, обычно позволяют увеличить основные проблемы, которые не были замечены или были нерешены в течение этого времени. Если фиефдомс препятствует успешной работе компании, вероятнее всего, изменения лидера в области.
>
