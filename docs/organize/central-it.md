...
description: Используйте облачную платформу внедрения для Azure, чтобы узнать, как создать централизованную ИТ-группу для работы по внедрению в облако.
