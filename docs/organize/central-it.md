---
title: Основные сведения о функциях центрального ИТ
description: Изучите функции центральной ИТ, включая источник, область, конечный результат и риски.
...
ms.locfileid: "83755837"
---
# <a name="central-it-functions"></a>Функции центрального ИТ-отдела
