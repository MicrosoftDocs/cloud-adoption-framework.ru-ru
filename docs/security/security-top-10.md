...
| Решение         | Description           | Типичная команда  |
| ------------- |-------------| -----|
...
Это относится либо к DevOps командам, управляющим собственными ресурсами приложений, либо к группам, ориентированным на технологии, в **[центральных ИТ-операциях](../organize/central-it.md)**:
...
- *Выполнение* — интеграция обнаружения угроз машинного кода — это совместная работа, включающая в себя:
  ...
  - **[Подготовка инцидентов](../organize/cloud-security-incident-preparation.md)**. Интегрируйте облачные инциденты в упражнения и обеспечьте проведение упражнений для обеспечения готовности команды.
  ...
  - **[Инфраструктура и конечная точка](../organize/cloud-security-infrastructure-endpoint.md)**  /  **[Централизованная ИТ](../organize/central-it.md)**: Настройка и включение обнаружений, интеграция в автоматизацию и инфраструктуру в качестве решений для кода.
...
- *Выполнение* — это совместная работа, включающая:
  ...
  - **[Политика и стандарты](../organize/cloud-security-policy-standards.md)**: политика документов и монитор для обеспечения соответствия
...
- *Выполнение* — стратегия безопасности должна быть реализована всеми пользователями, поэтому она должна интегрировать входные данные из разных групп, чтобы увеличить владение, Купить и вероятность успеха.
  - **[Архитектура безопасности](../organize/cloud-security-architecture.md)**: позволяет создавать стратегию безопасности и результирующую архитектуру, активно собирать отзывы от групп и документировать ее в презентациях, документах и схемах для различных аудиторий.
   - **[Политика и стандарты](../organize/cloud-security-policy-standards.md)**: записывает соответствующие элементы в стандарты и политики, а затем отслеживает соответствие.
...
- **[Создание группы стратегий облака](../get-started/team/cloud-strategy.md)**. в идеале безопасность должна быть интегрирована в существующую облачную стратегию.
