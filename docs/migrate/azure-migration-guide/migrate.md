...
description: Это руководство поможет вам начать перенос своей среды, определив подходящие инструменты для достижения состояния готовности, в том числе нативные инструменты, сторонние инструменты и инструменты управления проектами.
author: matticusau
ms.author: mlavery
ms.date: 08/08/2019
ms.topic: guide
...
1. Выберите **Review + add tools** (Проверка и добавление инструментов) и проверьте конфигурацию. Щелкните **Add tools** (Добавить инструменты), чтобы запустить задание для создания проекта миграции и регистрации выбранных решений.
