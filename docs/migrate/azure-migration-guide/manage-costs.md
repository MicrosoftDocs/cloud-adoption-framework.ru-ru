...
- Дополнительные сведения о службе "Управление затратами Azure" и функции выставления счетов приведены в статье [Общие сведения об областях и работа с ними](https://docs.microsoft.com/azure/cost-management/understand-work-scopes) и кратком руководстве по [изучению и анализу затрат с помощью функции анализа затрат](https://docs.microsoft.com/azure/cost-management/quick-acm-cost-analysis).
