...
2. На странице **Обзор** проекта щелкните **+Создать оценку**.
3. Щелкните **Просмотреть все**, чтобы просмотреть свойства оценки.
4. Создайте группу и укажите ее имя.
5. Выберите компьютеры, которые необходимо добавить в группу.
6. Щелкните **Создать оценку**, чтобы создать группу и оценку.
7. После создания оценки просмотрите ее, выбрав "Обзор" > "Панель мониторинга".
8. В разделе "Сведения об оценке" в колонке навигации портала выберите **Сведения о затратах**.
...
1. Перейдите к разделу **Управление затратами + выставление счетов** на портале. Если пункт "Управление затратами + выставление счетов" не отображается в области слева, щелкните **Все службы**. В области меню служб в разделе **Мониторинг и управление** щелкните **Управление затратами + выставление счетов**.
