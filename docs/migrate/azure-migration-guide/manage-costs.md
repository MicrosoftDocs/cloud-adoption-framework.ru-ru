...
В этой статье содержатся сведения об инструментах, которые помогут принимать разумные решения до, во время и после переноса рабочих нагрузок в Azure.
...
- [Калькулятор цен Azure](https://azure.microsoft.com/pricing/calculator/) предоставляет оценку затрат для выбранных продуктов Azure.
...
Миграция Azure вычисляет ежемесячные затраты на основе данных, собранных сборщиком и решением "Сопоставление служб". Следующие действия позволяют загрузить оценки затрат.

1. Перейдите к колонке **оценки службы "Миграция Azure"** на портале.
1. На странице **Обзор** проекта щелкните элемент **+ Создать оценку**.
...
1. Щелкните элемент **Создать оценку**, чтобы создать группу и оценку.
1. После создания оценки просмотрите ее, выбрав **Обзор** > **Панель мониторинга**.
1. В разделе **Сведения об оценке** в колонке навигации портала выберите элемент **Сведения о затратах**.
...
![Просмотр сведений о затратах](./media/manage-costs/compute-storage-monthly-cost-estimate.png)

*Рис. 1. Диаграмма представления "Сведения о затратах" для оценки в Миграции Azure.*

### <a name="additional-resources"></a>Дополнительные ресурсы

- [Настройка и проверка оценки с помощью Миграции Azure](/azure/migrate/tutorial-assess-vmware-azure-vm#set-up-an-assessment)
- Более полный план по управлению затратами на большее количество ресурсов (инфраструктура, приложения и данные) приведены в разделе [Стратегии действенного управления](../../govern/guides/index.md). В частности, см. руководства по [дисциплине "Управление затратами"](../../govern/cost-management/index.md) и [улучшению этой дисциплины](../../govern/guides/complex/cost-management-improvement.md).
...
### <a name="azure-cost-management--billing"></a>Управление затратами и выставление счетов Azure

Набор средств "Управление затратами + выставление счетов Azure" может дать более целостное представление о характере расходов, включая подробное представление затрат и тенденций расходов с течением времени. Для больших или сложных миграций это представление может содержать полезные сведения, необходимые для принятия широкомасштабных решений по управлению затратами.

**Предварительные условия.** В оставшейся части этой вкладки предполагается, что читатель настроил набор средств "Управление затратами + выставление счетов Azure" при работе с руководством по настройке Azure. Дополнительные сведения о настройке набора средств "Управление затратами + выставление счетов Azure" см. в статье [Управление затратами и выставление счетов за ресурсы Azure](../../ready/azure-setup-guide/manage-costs.md) в разделе руководства по настройке Azure. После заполнения данных выполните следующие шаги, чтобы оценить ежемесячные затраты на основе собранных данных.

Следующие действия позволяют загрузить данные анализа затрат набора средств "Управление затратами + выставление счетов Azure" для ваших подписок:

1. Перейдите к разделу **Управление затратами + выставление счетов** на портале. Если пункт **Управление затратами + выставление счетов** не отображается в области слева, щелкните элемент **Все службы**. В области меню служб в разделе **Мониторинг и управление** щелкните **Управление затратами и выставление счетов**.
2. В колонке **Управление затратами + выставление счетов** в области навигации слева щелкните элемент **Управление затратами**, чтобы начать анализ и оптимизацию затрат на облако.
3. В колонке **Управление затратами** выберите элемент **Анализ затрат**.
...
- Более полный план по управлению затратами на большее количество ресурсов (инфраструктура, приложения и данные) приведены в разделе [Стратегии действенного управления](../../govern/guides/index.md). В частности, см. сведения о [дисциплине "Управление затратами"](../../govern/cost-management/index.md) и об [улучшении этой дисциплины](../../govern/guides/complex/cost-management-improvement.md).
- Дополнительные сведения о Помощнике по Azure приведены в статье об [уменьшении затрат на обслуживание с помощью Помощника по Azure](/azure/advisor/advisor-cost-recommendations).
- Дополнительные сведения о наборе средств "Управление затратами + выставление счетов Azure" приведены в статье [Общие сведения об областях и работа с ними](/azure/cost-management-billing/costs/understand-work-scopes) и кратком руководстве по [изучению и анализу затрат с помощью функции анализа затрат](/azure/cost-management-billing/costs/quick-acm-cost-analysis).
...
Благодаря [резервированию в Azure](/azure/cost-management-billing/reservations/save-compute-costs-reservations) можно предварительно оплатить использование вычислительной мощности виртуальной машины или Базы данных SQL за один или три года. Предварительная оплата позволяет получить скидку на использование ресурсов. Однолетние и трехлетние контракты на резервирование обеспечивают существенную экономию (до 72 %) при оплате вычислительных ресурсов для виртуальной машины или Базы данных SQL по мере использования. Резервирования предоставляют скидку при выставлении счетов и не влияют на состояние выполнения ваших виртуальных машин или баз данных SQL.
...
### <a name="low-priority-vms-with-batch"></a>Использование низкоприоритетных виртуальных машин с пакетной службой

Для фоновых процессов с более низким приоритетом пакетная служба предлагает средства управления виртуальными машинами фоновых служб и снижения затрат. Но важно понимать, как влияет на производительность [использование низкоприоритетных виртуальных машин с пакетной службой](/azure/batch/batch-low-pri-vms), прежде чем выбрать этот вариант со скидкой.

### <a name="additional-resources"></a>Дополнительные ресурсы

Более полный план по управлению затратами на большее количество ресурсов (инфраструктура, приложения и данные) описан в статье о [модели системы управления Cloud Adoption Framework](../../govern/guides/index.md). В частности, см. сведения о [дисциплине "Управление затратами"](../../govern/cost-management/index.md) и об [улучшении этой дисциплины](../../govern/guides/complex/cost-management-improvement.md).
