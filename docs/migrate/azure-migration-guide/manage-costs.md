...
- Дополнительные сведения о наборе средств "Управление затратами + выставление счетов Azure" приведены в статье [Общие сведения об областях и работа с ними](/azure/cost-management/understand-work-scopes) и кратком руководстве по [изучению и анализу затрат с помощью функции анализа затрат](/azure/cost-management/quick-acm-cost-analysis).
