...
description: Этот раздел руководств по миграции Azure поможет вам оценить свою среду, чтобы определить, что именно необходимо перенести и какие методы миграции лучше использовать.
author: matticusau
ms.author: mlavery
ms.date: 08/08/2019
ms.topic: guide
