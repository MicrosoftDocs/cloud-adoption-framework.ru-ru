...
1. В проекте "миграция Azure" > **серверы**, служба "миграция **Azure": миграция серверов**, щелкните **репликация**.
...
1. В **целях миграции** > **серверы** > **службе "миграция Azure": миграция сервера**, щелкните **тест перенесенные серверы**.
...
1. В проекте "миграция Azure" > **серверы** > миграции **Azure: миграция сервера**щелкните **репликация серверов**.
