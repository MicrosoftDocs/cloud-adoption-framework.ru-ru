...
**Инфраструктура Azure** | [Узнайте, как](contoso-migration-infrastructure.md) компания Contoso настраивает инфраструктуру Azure.<br/><br/> Узнайте больше о [требованиях](/azure/migrate/contoso-migration-rehost-vm#prerequisites) к средству миграции серверов Миграции Azure.
...
[Узнайте больше о](/azure/migrate/) настройке средства миграции серверов Миграции Azure. 
...
- [Узнайте больше](/azure/migrate/contoso-migration-rehost-vm#prepare-vms-for-migration) о подготовке виртуальных машин к миграции.
...
- [Узнайте, как](/azure/migrate/tutorial-migrate-vmware#run-a-test-migration) выполнить тестовую отработку отказа.
- [Узнайте больше](/azure/migrate/tutorial-migrate-vmware#migrate-vms) о переносе виртуальных машин в Azure. 
