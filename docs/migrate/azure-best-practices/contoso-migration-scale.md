...
- В vCenter компания Contoso будет организовывать виртуальные машины в папки. Это упростит акцентирование внимания, так как будут оцениваться виртуальные машины в определенной папке.
