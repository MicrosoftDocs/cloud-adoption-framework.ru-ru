...
- Компания Contoso создаст виртуальные рабочие столы Windows, чтобы разработчики использовали их в удаленных расположениях.
...
1. Contoso настраивает формулу с учетом размера и артефактов. Артефакты включают SQL Server Management Studio, которые необходимы для этой формулы виртуальной машины разработки базы данных.
   ...
   Дополнительные сведения об использовании [формул](/azure/lab-services/devtest-lab-manage-formulas) с DevTest Labs.
...
[Создайте экземпляр DevTest Labs](/azure/lab-services/devtest-lab-create-lab) в своей подписке и Узнайте, как использовать [DevTest Labs для разработчиков](/azure/lab-services/devtest-lab-developer-lab).