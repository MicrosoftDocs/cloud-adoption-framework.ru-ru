...
> [!NOTE]
> Компания Contoso обнаружила различные базы данных с открытым исходным кодом на этапе оценки. По отдельности, они [переходят базы данных с открытым исходным кодом в Azure](./contoso-migration-oss-db-to-azure.md) для планирования миграции.
