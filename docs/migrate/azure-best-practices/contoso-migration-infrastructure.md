...
- Узнайте больше об [Azure AD для Office 365](https://docs.microsoft.com/office365/enterprise/about-office-365-identity)и о том, как [Добавить подписку в существующий клиент Azure AD](https://docs.microsoft.com/azure/active-directory/fundamentals/active-directory-how-subscriptions-associated-directory).
...
2. В поле **Добавление роли назначения роли**  >  **Role**> **участник**выбирается группа **контосокобрг** из списка. После этого группа появляется в списке **Выбранные элементы**.
...
| ENV | Допустимые значения: DEV, STG и произ. Представляет среду разработки, промежуточную среду и рабочую среду. |
