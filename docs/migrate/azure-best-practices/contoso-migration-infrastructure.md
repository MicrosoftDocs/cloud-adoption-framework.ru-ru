...
Contoso развернет концентраторы в каждом регионе. Концентратор — это виртуальная сеть в Azure, которая выступает в качестве центральной точки подключения к локальной сети. Концентратор виртуальных сетей будет подключаться друг к другу через глобальную пиринг виртуальных сетей, который подключает виртуальных сетей между регионами Azure.
...
| **Региональной** | **Range** | **Кэширующий узел** |
| --- | --- | --- |
