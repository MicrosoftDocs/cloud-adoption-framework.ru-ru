...
- Создает шаблон на основе текущих средств и процессов для использования в дополнительных миграциях из исходной среды Netezza.
