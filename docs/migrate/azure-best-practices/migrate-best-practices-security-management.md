...
- Дополнительные сведения о [Шифрование службы хранилища Azure для неактивных данных](https://docs.microsoft.com/azure/storage/common/storage-service-encryption).
...
- Сведения о [прозрачное шифрование данных Azure SQL с ключом, управляемым клиентом](https://docs.microsoft.com/azure/sql-database/transparent-data-encryption-byok-azure-sql).
...
![Защита от вредоносных программ для виртуальных машин](./media/migrate-best-practices-security-management/antimalware.png) <br/>
_Защита от вредоносных программ для виртуальных машин_
...
![Защитите веб-приложения](./media/migrate-best-practices-security-management/web-apps.png) <br/>
_Azure Key Vault_;

**Подробнее:**

- [Обзор](https://docs.microsoft.com/azure/key-vault/general/overview) хранилища Azure Key Vault.
...
![Управление доступом](./media/migrate-best-practices-security-management/subscription.png) <br/>
_Управление доступом — IAM_
...
![Пользователи и группы](./media/migrate-best-practices-security-management/azure-ad.png) <br/>
_Создание пользователей и групп Azure AD_
...
![Именование](./media/migrate-best-practices-security-management/naming.png) <br/>
_Именование групп ресурсов_
...
![Блокировки удаления](./media/migrate-best-practices-security-management/locks.png) <br/>
_Блокировки удаления_
...
![Маркировк](./media/migrate-best-practices-security-management/tagging.png) <br/>
_Маркировк_

**Подробнее:**

- [Сведения](https://docs.microsoft.com/azure/azure-resource-manager/management/tag-resources) о добавлении тегов и их ограничениях.
- [Просмотрите](https://docs.microsoft.com/azure/azure-resource-manager/management/tag-resources#powershell) примеры PowerShell и CLI для настройки добавления тегов, а также для применения тегов из группы ресурсов к ее ресурсам.
...
![Группы управления](./media/migrate-best-practices-security-management/management-groups.png) <br/>
_Группы управления_

**Подробнее:**

- [Сведения](https://docs.microsoft.com/azure/governance/management-groups) об организации ресурсов в группы управления.
...
![Политика Azure](./media/migrate-best-practices-security-management/policy.png) <br/>
_Политика Azure_
...
- [Сведения](https://docs.microsoft.com/azure/backup/backup-overview) о разных типах резервного копирования.
...
Кроме того, можно использовать сторонние решения для резервного копирования виртуальных машин Azure и контейнеров хранилища в локальное хранилище или на ресурсы других поставщиков облачных служб. [Узнайте больше](https://azuremarketplace.microsoft.com/marketplace/apps?search=backup&page=1) о решениях резервного копирования в Azure Marketplace.

### <a name="set-up-disaster-recovery-for-iaas-apps"></a>Настройка аварийного восстановления для приложений IaaS

Помимо защиты данных, планирование BCDR необходимо учитывать, как обеспечить доступность приложений и рабочих нагрузок в случае аварии. Для рабочих нагрузок, выполняющихся на виртуальных машинах IaaS Azure и в хранилище Azure рассмотрите следующие решения:
...
![Управляемые диски](./media/migrate-best-practices-security-management/managed-disks.png) <br/>
_Управляемые диски_
...
- [Дополнительные сведения](https://docs.microsoft.com/azure/azure-monitor/overview) Azure Monitor.
...
![Журнал ведения диагностики](./media/migrate-best-practices-security-management/diagnostics.png) <br/>
_Ведение журналов диагностики_

**Подробнее:**

- [Сведения](https://docs.microsoft.com/azure/azure-monitor/platform/platform-logs-overview) о сборе и использовании данных журнала.
...
![Оповещения](./media/migrate-best-practices-security-management/alerts.png) <br/>
_Оповещения_

**Подробнее:**

- [Сведения](https://docs.microsoft.com/azure/azure-monitor/platform/alerts-overview) об оповещениях.
...
![Панель мониторинга Azure](./media/migrate-best-practices-security-management/dashboard.png) <br/>
_Панель мониторинга Azure_
...
![Планы поддержки](./media/migrate-best-practices-security-management/support.png) <br/>
_Планы поддержки_
...
![Обновления виртуальной машины](./media/migrate-best-practices-security-management/updates.png) <br/>
_Обновления_
...
![Управление изменениями](./media/migrate-best-practices-security-management/change.png) <br/>
_Управление изменениями_
