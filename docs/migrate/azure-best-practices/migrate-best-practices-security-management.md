...
- [Обзор](https://docs.microsoft.com/azure/key-vault/general/key-vault-overview) хранилища Azure Key Vault.
...
_Пользователи и группы Azure AD_
...
- [Сведения](https://docs.microsoft.com/azure/architecture/best-practices/scaling) об автомасштабировании.
