...
- Узнайте о [прозрачном шифровании данных SQL Azure с помощью управляемого клиентом ключа](/azure/sql-database/transparent-data-encryption-byok-azure-sql).
...
- Сведения об [управлении обновлениями в Azure](/azure/automation/automation-update-management).
- Узнайте, как [интегрировать Configuration Manager с управлением обновлениями](/azure/automation/oms-solution-updatemgmt-sccmintegration).
