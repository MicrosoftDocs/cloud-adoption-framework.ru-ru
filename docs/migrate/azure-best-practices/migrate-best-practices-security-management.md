...
- Прочитайте о [прозрачном шифровании данных для базы данных SQL и Azure синапсе](/azure/azure-sql/database/transparent-data-encryption-tde-overview).
- Сведения о [прозрачном шифровании данных в базе данных SQL Azure с помощью ключа, управляемого клиентом](/azure/azure-sql/database/transparent-data-encryption-byok-overview).
...
- С помощью Azure RBAC можно назначать роли субъектам безопасности, таким как владелец, участник и читатель, и определения ролей (коллекция разрешений), которые определяют операции, которые могут быть выполнены ролями.
- В Azure RBAC также можно задать области, которые задают границу для роли. Область можно задать на нескольких уровнях, включая группу управления, подписку, группу ресурсов или ресурс.
