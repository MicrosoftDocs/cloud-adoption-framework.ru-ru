...
- **Виртуальные машины.** Для виртуальных машин можно использовать Шифрование дисков Azure. Эта служба позволяет шифровать диски виртуальных машин IaaS под управлением Windows и Linux.
...
- **Среда службы приложений.** Если для переносимого приложения нужна дополнительная защита, рекомендуем добавить Среду службы приложений и брандмауэр веб-приложения для защиты ресурсов приложения.
...
- **Брандмауэр веб-приложения.** Функция Шлюза приложений Azure, обеспечивающая централизованную защиту веб-приложений.
  ...
  - Брандмауэр веб-приложения можно отслеживать с помощью Azure Monitor. Также он интегрирован в Центр безопасности Azure.

![Защитите веб-приложения](./media/migrate-best-practices-security-management/web-apps.png)
...
- Доступ к отчетам безопасности зависит от лицензии Azure AD. В ценовой категории "Бесплатный" и "Базовый" вы получаете список пользователей, выполнявших рискованные действия, и рискованных операций входа в систему. В выпусках "Премиум 1" и "Премиум 2" предоставляются сведения о базовом событии.
...
*Создание пользователей и групп Azure AD*
...
- [Настройка групп управления.](#best-practice-manage-resources-with-azure-management-groups) При наличии нескольких подписок, можно объединить их в группы управления и применить параметры управления к группам.
...
![Служба Azure Site Recovery](./media/migrate-best-practices-security-management/site-recovery.png)
...
Управляемые диски Azure упрощают администрирование дисков виртуальных машин Azure IaaS. Эта функция управляет учетными записями хранения, связанными с этими дисками.
