...
1. В Visual Studio они обновляют файл */deploy/k8s/config_local. yml* с помощью сведений о подключении к базе данных, упомянутых ранее.
    ...
    ![Снимок экрана, показывающий кнопку * * Новый конвейер * * в Visual Studio.](./media/contoso-migration-rebuild/back-pipe1.png)
    *Рис. 28. подключения к базе данных.*
