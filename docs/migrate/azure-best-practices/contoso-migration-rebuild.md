...
[Обработайте и классификация образов с помощью служб "самостоятельное представление Azure](https://docs.microsoft.com/learn/paths/classify-images-with-vision-services/)". Azure Cognitive Services предлагает предварительно созданные функции для включения в приложения функциональных возможностей компьютерных концепций. Узнайте, как использовать службы распознавания концепций для обнаружения лиц, тегов и классификации изображений, а также для идентификации объектов.
