...
- **Калькулятор цен Azure:** Выберите продукты, которые требуется оценить, например виртуальные машины и хранилище. Чтобы произвести оценку, введите затраты в калькулятор цен.
 ...
 ![калькулятор цен Azure](./media/migrate-best-practices-costs/pricing.png) *калькуляторе цен Azure*
...
**Data type** | **Сведения** | **Использование**
--- | --- |  ---
