...
- Создайте бюджет для финансовой отчетности.
   ...
   *Рис. 4. Управление затратами Azure + бюджет по счету.*
...
- Рекомендации [по обеспечению безопасности и управлению](./migrate-best-practices-security-management.md) после миграции.
- Рекомендации по работе с [сетью](./migrate-best-practices-networking.md) после миграции.
