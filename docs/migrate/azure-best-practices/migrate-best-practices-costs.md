...
| Тип данных | Подробности | Использование |
| --- | --- | --- |
...
| Уровень доступа | Подробности | Использование |
| --- | --- | --- |
...
| Тип учетной записи | Подробности | Использование |
| --- | --- | --- |
...
- Сведения об [импорте и экспорте Azure](https://docs.microsoft.com/azure/storage/common/storage-import-export-service).
...
- Ознакомьтесь [с руководством по ценам SQL Server на виртуальных машинах Azure](https://docs.microsoft.com/azure/virtual-machines/windows/sql/virtual-machines-windows-sql-server-pricing-guidance).
