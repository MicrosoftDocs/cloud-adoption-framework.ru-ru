...
| **Security** | Contoso должен быть уверен, что база данных доступна только для внутренних приложений и недоступна или не доступна через Интернет. |
