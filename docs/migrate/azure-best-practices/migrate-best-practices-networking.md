...
- Ознакомьтесь с [топологией звезды](https://docs.microsoft.com/azure/architecture/reference-architectures/hybrid-networking/hub-spoke).
...
- Сведения о [настройке BGP с VPN-шлюзами Azure](https://docs.microsoft.com/azure/vpn-gateway/vpn-gateway-bgp-overview).
...
- Ознакомьтесь с [обзором](https://docs.microsoft.com/azure/expressroute/expressroute-introduction) ExpressRoute.
...
| Имя правила | Назначение | Подробности |
| --- | --- | --- |
