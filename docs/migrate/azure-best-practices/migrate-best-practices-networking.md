...
- Если вы совершенно не можете переконструировать сеть, это может помочь в преобразовании сетевых адресов (NAT). Но следует избегать или ограничиваться настолько, насколько это возможно.
