...
![Схема топологии HUB и звезды ](./media/migrate-best-practices-networking/hub-spoke.png)
 _рис. 1. топология концентратора и звезды._
...
- Чтобы обеспечить отказоустойчивость зональные, можно развернуть стандартный экземпляр Azure Load Balancer с рабочими нагрузками с выходом в Интернет или уровнями приложений.
    ...
    ![Схема подсистемы балансировки нагрузки уровня ](./media/migrate-best-practices-networking/load-balancer.png) _"Стандартный" рис. 4. Подсистема балансировки нагрузки._
