...
4. **Заполните импорт.** Contoso может заполнить недостающие поля в файле импорта, включая параметры DACPAC. Чтобы начать с них, укажите, что им нужно выполнить **пробный** импорт, чтобы убедиться, что все работает правильно перед полной миграцией.
