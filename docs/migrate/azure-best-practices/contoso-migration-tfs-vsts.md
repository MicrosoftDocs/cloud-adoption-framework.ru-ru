...
13. Руководитель dev открывает один из проектов и открывает**для меня назначенные им** **рабочие элементы** > . Будет показано, что данные рабочих элементов были перенесены вместе с идентификатором.
...
9. Руководитель dev открывает один из проектов и открывает**для меня назначенные им** **рабочие элементы** > . Будет показано, что данные рабочих элементов были перенесены вместе с идентификатором.
