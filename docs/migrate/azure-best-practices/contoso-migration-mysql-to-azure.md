...
MySQL использует схему управления версиями _x. y. z_ , где _x_ — это основная версия, а _y_ — дополнительный номер версии, а _z_ — версия исправления.
