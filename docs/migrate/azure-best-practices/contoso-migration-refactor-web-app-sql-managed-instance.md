...
- Обновите внутреннюю документацию, чтобы показать новые расположения приложения SmartHotel360. Отобразите базу данных как выполняемую в базе данных SQL Управляемый экземпляр Azure, а внешний интерфейс — в двух веб-приложениях.
