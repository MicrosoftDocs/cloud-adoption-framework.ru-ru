...
ms.locfileid: "76807484"
---
# <a name="assess-on-premises-workloads-for-migration-to-azure"></a>Оценка локальных рабочих нагрузок для миграции в Azure
...
Технология | Description | Затраты
--- | --- | ---
...
8. В **средстве Выбор средства оценки**выберите **Миграция Azure: Оценка сервера** > **Далее**.
...
2. В разделе **Обнаружение компьютеров** > **виртуальных машин?** нажмите кнопку **Да, используя гипервизор VMware vSphere**.
