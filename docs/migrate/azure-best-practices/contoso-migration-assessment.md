...
3. Созданный хэш должен соответствовать хэш-значениям, указанным в разделе [Проверка безопасности](https://docs.microsoft.com/azure/migrate/tutorial-assess-vmware#verify-security) руководства [Оценка виртуальных машин VMware с помощью средства "Оценка серверов" службы "Миграция Azure"](https://docs.microsoft.com/azure/migrate/tutorial-assess-vmware).
