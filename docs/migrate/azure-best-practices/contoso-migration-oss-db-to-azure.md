...
- Убедитесь, что новые рабочие нагрузки базы данных Azure защищены. Дополнительные сведения см. в статьях [база данных SQL Azure и возможности безопасности sql управляемый экземпляр](/azure/azure-sql/database/security-overview).
...
- Включите защитник Майкрософт для идентификации.
