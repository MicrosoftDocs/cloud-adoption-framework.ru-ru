...
- Регионы Azure развертываются парами. В случае катастрофического сбоя региона другой регион в пределах той же геоошибочной границы назначается в качестве парного региона. Следует продумать возможность развертывания в парных регионах в качестве основной и дополнительной стратегии устойчивости. Azure Бразилия — это важное исключение, парная область которого — Юго-Центральный регион США. Дополнительные сведения см. в статье [Непрерывность бизнес-процессов и аварийное восстановление в службах BizTalk: пары регионов Azure](https://docs.microsoft.com/azure/best-practices-availability-paired-regions).
