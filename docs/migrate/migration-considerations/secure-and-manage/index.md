...
Узнайте больше о возможностях платформы [Azure Monitor](/azure/azure-monitor/overview) для мониторинга перенесенных ресурсов.
...
Дополнительные сведения о защите перенесенных ресурсов см. в статье [о Центре безопасности Azure](/azure/security-center).
...
Узнайте больше о возможностях службы [Azure Backup](/azure/backup) для защиты перенесенных ресурсов.
