...
![Матрица Изона: проблемы внедрения пользователей](../../../_images/eason-matrix.jpg)
...
- Был ли определен ожидаемый [бизнес-результат](../../../business-strategy/business-outcomes/index.md)?
- Сопоставим ли эффект от бизнеса с определенными [метриками обучения](../../../business-strategy/learning-metrics.md)?
