...
Когда следует оптимизировать ресурс &mdash;, во время миграции или после нее? Ответ прост — _и до и после_. Однако это не вполне точно. Для объяснения рассмотрим два основных сценария оптимизации размера ресурса:
