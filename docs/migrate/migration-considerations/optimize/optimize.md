...
[Управление затратами Azure](/azure/cost-management/overview), лицензированное компанией Cloudyn, подразделением корпорации Майкрософт, прозрачно и точно управляет затратами на облако. Эта служба отслеживает, тестирует, распределяет и оптимизирует затраты на облачные ресурсы.
