...
| Оценка | Риски | Помощь команде по внедрению в облако в оценке воздействия реальных бизнес-рисков. |
| Оценка | Утвердить | Проверка и подтверждение влияния на бизнес предлагаемых изменений архитектуры. |
...
|---------|---------|---------|---------|
| Предварительные требования | Цифровые активы | Согласуйте имеющиеся запасы в соответствии с основными допущениями на основе результатов бизнеса. | Команда по вопросам облачной стратегии |
| Предварительные требования | Невыполненная работа по миграции | Определите последовательность рабочих нагрузок, подлежащих миграции. | Команда по вопросам облачной стратегии |
| Оценка | Архитектура | Испытайте начальное предположение, чтобы определить целевую архитектуру на основе метрик использования. | Команда по внедрению в облако |
