---
title: 'Подготовка к технической сложности: гибкое управление изменениями'
titleSuffix: Microsoft Cloud Adoption Framework for Azure
description: Подготовка к технической сложности — гибкое управление изменениями
...
## <a name="addressing-technical-complexity"></a>Решение проблемы технической сложности
...
- **Независимая:** Рабочая нагрузка не должна иметь каких-либо недоступных зависимостей. Чтобы рабочая нагрузка считалась перенесенной, все зависимости должны быть доступны, а также включены в трудозатраты миграции.
- **Оборотная:** В следствии осуществления дополнительного обнаружения изменяется определение рабочей нагрузки. Архитекторы, которые планируют миграцию, могут согласовать факторы зависимости. Примеры точек согласования могут включать предварительный выпуск функций, предоставляя доступ к функциям в гибридной сети или упаковывая все зависимости в один выпуск.
- **Полезная:** Ценность в рабочей нагрузке измеряется способностью предоставить пользователям доступ к производственной нагрузке.
- **Оцениваемая:** Зависимости, активы, время миграции, производительность и затраты на облако — все это должно быть оцениваемым и оценено перед миграцией.
- **Малая:** Целью является упаковка рабочих нагрузок в один спринт. Однако это не всегда применимо. Вместо этого, командам рекомендуется планировать спринты и выпуски, чтобы свести к минимуму время, необходимое для переноса рабочей нагрузки на производство.
- **Тестируемая:** Всегда должны существовать определенные средства тестирования или проверки завершения переноса рабочей нагрузки.
...
## <a name="migration-backlog-aligning-business-priorities-and-timing"></a>Невыполненная работа по миграции: Согласование бизнес-приоритетов и времени

Невыполненная работа по миграции позволяет отслеживать портфель верхнего уровня мигрируемых рабочих нагрузок. Перед миграцией команде по разработке стратегии облачных вычислений и команде по внедрению облачных вычислений нужно проверить текущие [цифровые активы](../../../digital-estate/index.md) и согласовать список переносимых приоритетных рабочих нагрузок. Этот список формирует основу первоначальной невыполненной работы по миграции.
...
При возникновении невыполненной работы по миграции команда по управлению изменениями должна стремиться к получению следующей информации о любой рабочей нагрузке, содержащейся в плане. Как минимум, эти данные должны быть доступны для любых рабочих нагрузок, приоритетных при миграции в следующих двух-трех выпусках.
...
- **Владелец бизнеса.** Задокументируйте одного человека, ответственного за принятие бизнес-решений в отношении этой рабочей нагрузки.
...
## <a name="release-backlog-aligning-business-change-and-technical-coordination"></a>Невыполненная работа по выпуску. Согласование изменений в бизнесе и технической координации
...
- **Ожидаемые результаты производительности.** Анализ доступных данных журналов, фиксирующих пропускную способность, просмотр страниц, сетевые маршруты и другие данные о производительности, необходимые для репликации интерфейса пользователя.
- **Зависимости.** Анализ сетевого трафика и шаблонов использования приложений для выявления любых дополнительных зависимостей рабочей нагрузки, которые должны учитываться при определении последовательности и готовности среды. Не включайте рабочую нагрузку в выпуск до тех пор, пока не будет выполнен один из следующих критериев.
...
- **Конфигурация.** Выбор конфигурации всех развернутых активов, включая ссылки на сценарии конфигурации.
...
- **Архитектура.** Документация архитектуры, развернутой в облаке.
