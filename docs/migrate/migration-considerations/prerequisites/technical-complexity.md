...
Для небольшой миграции с автономной миграционной командой один спринт может включать все четыре этапа миграции одной рабочей нагрузки (_оценка_, _миграция_, _оптимизация_ и _безопасность и управление_). Чаще всего, каждый из этих процессов разделяется несколькими командами в различных рабочих элементах между многочисленными спринтами. В зависимости от типа, масштаба и ролей трудозатрат, эти спринты могут принимать несколько различных форм.
