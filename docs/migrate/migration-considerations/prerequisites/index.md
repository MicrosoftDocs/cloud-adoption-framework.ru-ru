...
Прежде чем начинать миграцию в облако, изучите рекомендации по [планированию](../../../business-strategy/index.md) и [готовности](../../../ready/index.md) в Cloud Adoption Framework, чтобы правильно подготовить организацию к процессам внедрения облака и миграции. В частности, изучите бизнес-требования и предполагаемые результаты, которые определяют потребность в миграции.

- [руководство по началу работы Подготовка к выполнению миграции в облако.](../../../getting-started/migrate.md)
- [Почему мы переходим к облаку?](../../../business-strategy/motivations-why-are-we-moving-to-the-cloud.md)
...
- **Приоритеты бизнеса.** Обеспечьте принятие бизнес-решений по переносу рабочих нагрузок и по общим временным рамкам. См. дополнительные сведения о [причинах для миграции к облаку](../../../business-strategy/motivations-why-are-we-moving-to-the-cloud.md).
