...
- **Внедрение инноваций на основе данных**. Новые продукты или службы, особенно те, которые поступают из данных, являются примерами разрушающих результатов. Они являются результатом эксперимента и прогнозов, использующих данные для нарушения статуса кво на рынке.
