...
- Определение завершено, документировано и уточнено отдельно для процесса *оценки*, *переноса*, *оптимизации*и *обеспечения безопасности и управления* процессами миграции.
- Тип трудозатрат.
- Масштаб трудозатрат.
- Время трудозатрат.
