...
**Миграция и оптимизация:** [Облачное решение](https://download.microsoft.com/download/3/7/3/373F90E3-8568-44F3-B096-CD9C1CD28AB7/Cloud_Modernization_Datasheet_EN_US.pdf) служб Microsoft Services модернизации предлагает комплексный подход к переносу приложений и инфраструктуры в Azure, а также оптимизации и модернизировать один раз в облаке с помощью упрощенной миграции.
