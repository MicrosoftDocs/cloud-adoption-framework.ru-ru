...
| Элемент | Name | Описание |
| --- | --- | --- |
| Subscription |Contoso ETS DeveloperTools Production |Поддерживает типовые инструменты разработки. |
...
| Поле | Результат | Описание |
| --- | --- | --- |
| location |deny |Запретить создание ресурсов за пределами центров обработки данных США |
| tags |deny |Требование наличия тега владельца приложения. |
