...
Одна из основных задач группы ИТ-инфраструктуры — обеспечение согласованности схем IP-адреса на предприятии. Пространство частных IP-адресов, назначенное реализации постоянного тока, должно быть единообразным и **не** перекрываться с ЧАСТНЫМИ IP-адресами, назначенными в локальных сетях.
...
:::row:::
    ...
    :::column:::
        **Балансировка нагрузки** <br>
        ...
        [Шлюз приложений (уровень 7)][AppGW] <br>
...
:::row:::
    :::column:::
        **Удостоверение** <br>
        ...
        [Управление доступом на основе ролей в Azure][RBAC] <br>
        [Встроенные роли Azure][Roles]
    :::column-end:::
    :::column:::
        **Мониторинг** <br>
