...
**Внутренние**бизнес-приложения — это компьютерные приложения, критически важные для текущей работы предприятия. У них есть некоторые общие характеристики.
