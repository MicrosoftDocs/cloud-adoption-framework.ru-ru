...
В _плоской топологии_ все ресурсы развертываются в одной виртуальной сети. Подсети допускают управление потоком и разделение.

![11][11]

В _топологии сетки_ пиринг виртуальных сетей соединяет все виртуальные сети напрямую друг с другом.
