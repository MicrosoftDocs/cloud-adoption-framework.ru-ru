...
![Иерархия портфеля, платформы, целевой зоны, рабочих нагрузок и ресурсов. В списке от самого высокого до самого низкого порядка во вложенной связи типа «родители-потомки».](../../_images/ready/hierarchy.png)
...
- **Целевая зона:** Целевые зоны предоставляют рабочие нагрузки с доступом ко всем базовым _служебным программам_ (или общим механизмам), предоставляемым _платформой Platform Foundation_ , которая необходима для поддержки одной или нескольких рабочих нагрузок.
...
Некоторые компании, особенно быстро увеличивающиеся запуски, имеют более высокий средний процент настраиваемых проектов разработки. В портфеле, интенсивно разрабатываемом для разработки, среда, Главная зона и рабочие нагрузки часто сжимаются. в некоторых &mdash; рабочих нагрузках могут использоваться определенные среды (производственные или непроизводственные среды). Это приводит к соотношения 1:1 между средой, целевой зоной и рабочей нагрузкой. 
