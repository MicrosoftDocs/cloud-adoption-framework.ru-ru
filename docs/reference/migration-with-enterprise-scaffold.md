...
> [!TIP]
> Использование тегов служб и групп безопасности приложений в группах безопасности сети не только повышает удобочитаемость правил&mdash;, что очень важно для понимания влияния&mdash;, а также для обеспечения эффективной микросегментации в более крупной подсети, уменьшая степень увеличения и гибкость.
