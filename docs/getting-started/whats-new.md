...
Продолжение итерации руководства по переходу и готовности к более тесному согласованию с отзывами от клиентов, партнеров Майкрософт и внутренних программ Майкрософт.
...
| Статья                                                                                                                 | Описание                                                                                                                                                                                |
|-------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Рефакторинг целевых зон](../ready/landing-zone/refactor.md)                       | **Новая статья:** Рисование из готовых семинаров. в этой статье описывается теория начиная с исходного шаблона, с помощью деревьев принятия решений и рефакторинга для расширения целевой зоны и перехода к будущему состоянию готовности предприятия. |
| [Расширение целевой зоны](../ready/considerations/index.md)                       | **Новая статья:** Сборка в разделе параллельных итераций статьи рефакторинга показывает, как различные типы расширения целевой зоны внедряют общие принципы в поддерживающую платформу. (Исходное содержимое для этого обзора перемещено в узел [основные рекомендации по целевому](../ready/considerations/basic-considerations.md) элементу в содержании.) |
| [Разработка на основе тестирования (TDD) для начальных зон](../ready/considerations/test-driven-development.md)                       | **Новая статья:** Подход к рефакторингу значительно улучшен благодаря внедрению цикла разработки на основе тестирования для разработки и рефакторинга целевой зоны. |
...
| [Повышение безопасности зоны размещения](../ready/considerations/landing-zone-security.md)                       | **Новая статья:** Обзор рекомендаций, приведенных в этом разделе, с обратным привязкум к циклу TDD. |
| [Улучшение операций размещения в зонах](../ready/considerations/landing-zone-operations.md)                       | **Новая статья:** Список рекомендаций в статье Управление методологией с переходом к этому модульному подходу для улучшения операций, надежности и производительности. |
| [Улучшенное управление начальной зоной](../ready/considerations/landing-zone-governance.md)                       | **Новая статья:** Список рекомендаций по управлению методологией с переходом к этому модульному подходу для улучшения управления, затрат и масштабирования. |
| [Начало работы с корпоративным масштабом](../ready/considerations/enterprise-scale.md)                       | **Новая статья:** Продемонстрируйте подход, демонстрирующий различия в процессе, когда клиент начинает с шаблонов целевой зоны корпоративного уровня. Эта статья поможет клиентам понять квалификаторы, которые будут поддерживать это решение. |
...
| Статья                                                                       | Описание                                                                                                                                    |
|-------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------|
| [Балансировка портфеля](../strategy/balance-the-portfolio.md)                 | Эта статья была перемещена ранее в методологии стратегии. Это позволяет понять процесс обработки идей ранее в жизненном цикле. |
...
| [Миграция](../migrate/azure-migration-guide/migrate.md)                                           | Добавлена ссылка на Унификлауд в средствах сторонних поставщиков в ответ на Конференции на конференциях уровня 1.                                                         |
