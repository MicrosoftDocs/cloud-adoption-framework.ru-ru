...
> [!NOTE]
> В настоящее время это руководство является общедоступной предварительной версией. Терминология, подходы и рекомендации тщательно тестируются с клиентами, партнерами и Microsoft Teams во время этой предварительной версии. Таким образом, содержание и руководство могут немного меняться со временем.
...
![Методология облачной реализации инфраструктуры внедрения в облаке](../_images/migrate/methodology.png)
...
**Приступая к работе:** Начните облачную реализацию с помощью [инструкции по миграции Azure](../migrate/azure-migration-guide/index.md) и [инструкции по установке Azure](../ready/azure-setup-guide/index.md), в которой описаны средства и высокоуровневые процессы, необходимые для успешного выполнения реализации облака. Перенос первой рабочей нагрузки с помощью этих руководств поможет команде преодолеть начальные кривые обучения на ранних этапах процесса планирования. После этого необходимо предоставить рекомендации по [миграции](../migrate/azure-best-practices/index.md) и рекомендации по [миграции](../migrate/migration-considerations/index.md) , чтобы согласовать базовые требования с уникальными ограничениями, процессами, структурами команды и целями.
...
>
> [Планирование](../plan/index.md)
>
> [Готово](../ready/index.md)
>
> [Миграция](../migrate/index.md)
>
> [Внедрять инновации](../innovate/index.md)
>
> [Ограничен](../govern/index.md)
>
> [Управление](../manage/index.md)
>
> [Организовать](../organize/index.md)
