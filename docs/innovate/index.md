...
| <br>![4](../_images/icons/4.png)      | [Циклы обратной связи.](./considerations/adoption.md) При каждой итерации команды специалистов могут изучать создаваемые решения вместе с клиентами. Быстрые и точные циклы обратной связи с клиентами помогут вам повысить качество тестирования, оценки и обучения, ускоряя выпуск продукта на рынок. Узнайте, как Azure и GitHub помогают ускорить циклы обратной связи.                        |
