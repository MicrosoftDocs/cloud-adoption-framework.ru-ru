...
| --- | --- |
| [Компьютерное зрение](https://docs.microsoft.com/azure/cognitive-services/computer-vision/) | Компьютерное зрение предоставляет доступ к расширенным алгоритмам обработки изображений и возврата информации. |
