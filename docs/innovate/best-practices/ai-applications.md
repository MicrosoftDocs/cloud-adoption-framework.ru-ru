...
| [Пользовательское визуальное распознавание](/azure/cognitive-services/custom-vision-service/overview) | Пользовательское визуальное распознавание позволяет создавать пользовательские классификаторы изображений. |
...
| [Индексатор видео](/azure/media-services/video-indexer/video-indexer-overview) | Индексатор видео позволяет извлекать ценные сведения из видео. |
...
| [Распознавание говорящего](/azure/cognitive-services/speech-service/speaker-recognition-overview) (Предварительная версия) | API распознавания говорящего предоставляет алгоритмы для Идентификация говорящего и проверки. |
| [Распознавание речи Bing](/azure/cognitive-services/speech-service/how-to-migrate-from-bing-speech) (прекращено) | Вы можете перенести существующие API распознавания речи Bing приложения в службу распознавания речи. |
| [Перевод речи](/azure/cognitive-services/speech-service/how-to-migrate-from-translator-speech-api) (прекращено) | Вы можете перенести существующие приложения API перевода речи Bing в службу распознавания речи. |
...
| [QnA Maker](/azure/cognitive-services/qnamaker/) | QnA Maker позволяет создать службу вопросов и ответов из содержимого полуструктурированных. |
...
### <a name="decision-logic-apis"></a>API логики принятия решений
...
| [Content Moderator](/azure/cognitive-services/content-moderator/overview) | Content Moderator позволяет отслеживать потенциально оскорбительное, нежелательное и представляющее риск содержимое. |
