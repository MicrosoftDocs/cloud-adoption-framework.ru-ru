...
| [Перевод речи](/azure/cognitive-services/translator-speech/) (снято с учета) | Перевод речи — это служба машинного перевода. |

### <a name="language-apis"></a>API, связанные с языком

| Имя службы | Описание службы |
| --- | -- |
| [Распознавание речи (LUIS)](/azure/cognitive-services/luis/) | Служба Language Understanding (LUIS) позволяет приложению понять, какое слово хочет пользователь. |
