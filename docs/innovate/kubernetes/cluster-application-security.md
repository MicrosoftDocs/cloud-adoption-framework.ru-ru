...
> | **Настройка контейнера и решения для сканирования кластеров.** Проверяйте контейнеры, отправленные в реестр контейнеров Azure, и получайте более подробные представления об узлах кластера, облачном трафике и средствах управления безопасностью. | [Интеграция реестра контейнеров Azure с центром безопасности](/azure/security-center/defender-for-container-registries-introduction) <br> [Интеграция службы Kubernetes Azure с центром безопасности](/azure/security-center/defender-for-kubernetes-introduction)  |
...
> | Контрольный список | Ресурсы |
> |---|---|
> | **Применение политик управления кластерами.** Централизованное и согласованное применение ограничений и мер безопасности в кластерах. | [Управление развертываниями с помощью политики Azure](/azure/governance/policy/concepts/policy-for-kubernetes) |
