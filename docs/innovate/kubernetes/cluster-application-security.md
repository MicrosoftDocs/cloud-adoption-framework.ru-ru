...
> | Контрольный список  | Ресурсы |
> |------------------------------------------------------------------|-----------------------------------------------------------------|
> | **Управление доступом к кластерам с помощью членства в группах.** Настройте управление доступом на основе ролей (RBAC) Kubernetes, чтобы ограничить доступ к учетным данным пользователя или группе на основе ресурсов кластера. | [Управление доступом к кластерам с помощью RBAC и групп Azure AD](https://docs.microsoft.com/azure/aks/azure-ad-rbac)    |
