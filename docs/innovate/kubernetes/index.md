...
| | |
|---|---|
| ![Значок элемента 1](../../_images/icons/1.png) | <br>[Разработка и развертывание приложений.](./application-development.md) Изучите шаблоны и методики разработки приложений, настройте конвейеры DevOps и выполните рекомендации по обеспечению надежности информационных систем (SRE). |
