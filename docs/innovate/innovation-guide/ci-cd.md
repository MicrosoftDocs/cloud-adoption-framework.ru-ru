...
**Перейдите к [документации по Azure DevOps](/azure/devops/get-started/)**
...
- [Открытый код в Azure](https://azure.microsoft.com/overview/open-source/)
