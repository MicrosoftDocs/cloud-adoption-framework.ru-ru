...
1. Найдите и выберите службу:
    ...
    - Чтобы получить список API-интерфейсов Cognitive Services, щелкните ссылку **Подробнее** рядом с заголовком **Cognitive Services**. Затем выберите службу.
...
1. Щелкните команду **Добавить**, а затем выберите элемент **Бот веб-приложений** или **Регистрация каналов ботов**.
