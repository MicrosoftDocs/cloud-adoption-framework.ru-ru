...
- [Решения azure "Интернет вещей" (IOT)](https://docs.microsoft.com/azure/iot-fundamentals). коллекция служб в Azure, которая помогает управлять устройствами и потоками данных от этих устройств в облаке и обратно для конечных пользователей.
- [Azure Sphere](https://docs.microsoft.com/azure-sphere): сочетание оборудования и программного обеспечения, обеспечивающее надежный способ обеспечения безопасной передачи данных между устройством и решениями Azure IOT.
- [Azure KINECT DK](https://docs.microsoft.com/azure/Kinect-dk), датчики AI с расширенными компьютерное зрение и моделями речи. Эти датчики могут получать визуальные и звуковые данные из немедленной окружающей среды и передавать их в решение.
