...
- **[Мобильный интерфейс](#mobile-experience)** . как и в случае с ноутбуками, мобильные приложения более часто встречаются в клиентской среде. В некоторых случаях это может обеспечить достаточный уровень интерактивности для обеспечения внешнего взаимодействия решения.
...
- [Azure Sphere](/azure-sphere), сочетание оборудования и программного обеспечения. Azure Sphere — это небезопасный способ, позволяющий существующему устройству безопасно передавать данные между устройствами и решениями Azure IoT.
