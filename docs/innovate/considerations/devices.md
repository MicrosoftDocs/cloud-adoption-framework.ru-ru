...
- [Azure KINECT DK](/azure/Kinect-dk), датчики AI с расширенными компьютерное зрение и моделями речи. Эти датчики могут получать визуальные и звуковые данные из немедленной окружающей среды и передавать их в решение.
