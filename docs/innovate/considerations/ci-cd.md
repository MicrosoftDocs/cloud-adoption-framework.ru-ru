...
На следующем рисунке и в разделах описаны первоначальные реализации, поддерживающие эту методологию.
