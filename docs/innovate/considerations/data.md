...
Многие успешные нововведения были запущены в виде минимально приемлемых продуктов (MVP), которые обеспечивают ручные, управляемые данными процессы от имени клиента. В этой модели Concierge сотрудник является потребителем данных. Этот сотрудник использует данные для помощи клиентам. Каждый раз, когда клиент вовлечен в поддержку вручную, можно проверить и проверить гипотезу. Такой подход часто является экономичным средством тестирования гипотезы, ориентированной на клиентов, до того, как вы не потратите на интеграцию решений.
