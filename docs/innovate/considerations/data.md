...
Если требуется централизованное предоставление данных для устранения потребности клиентов, то, скорее всего, потребуется составлять данные из различных источников и перемещать их в централизованное хранилище данных. Существует два основных вида сбора данных: _Интеграция_ _и прием_.
