...
SQL Server 2017 и хранилище данных SQL Azure поддерживают [polybase](https://docs.microsoft.com/sql/relational-databases/polybase/polybase-guide), то есть подход к виртуализации данных, наиболее часто используемый в Azure.
