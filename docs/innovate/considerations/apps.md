...
В параллельном режиме Azure обеспечивает бессерверные параметры данных транзакций, которые также снижают затраты. [Список продуктов базы данных](/azure/) содержит параметры для размещения данных без необходимости полной платформы данных.
