...
Использование разработчиками-создателями может быть приемлемым и эффективным, когда ранние утверждения могут быть проверены с помощью таких средств, как [Power Apps](/powerapps/powerapps-overview) для интерфейсов приложений, [Построитель искусственного интеллекта](/powerapps/use-ai-builder) для процессов и прогнозов, [Microsoft Power автоматизиру](/power-automate/) для рабочих процессов и [Power BI](/power-bi/) для использования данных.
