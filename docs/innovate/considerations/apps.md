...
description: Введение в облачные инновации — Общайтесь с приложениями.
...
В параллельном режиме Azure обеспечивает бессерверные параметры данных транзакций, которые также снижают затраты. [Список продуктов базы данных](https://docs.microsoft.com/azure/#pivot=products&panel=databases) содержит параметры для размещения данных без необходимости полной платформы данных.
