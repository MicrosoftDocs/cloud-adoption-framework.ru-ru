...
- [Организация подписок Azure и управление ими](../azure-best-practices/organize-subscriptions.md)
...
- [Читатель](https://docs.microsoft.com/azure/role-based-access-control/built-in-roles#reader) — может просматривать все, включая данные о затратах и конфигурацию, но не может вносить какие-либо изменения.
...
Чтобы приступить к использованию службы "Управление затратами Azure", см. статью [Оптимизация инвестиций в облако с помощью службы управления затратами Azure](https://docs.microsoft.com/azure/cost-management-billing/costs/cost-mgt-best-practices?toc=/azure/cloud-adoption-framework/toc.json&bc=/azure/cloud-adoption-framework/_bread/toc.json).
...
- [Использование оповещений о затратах для мониторинга использования и расходов](https://docs.microsoft.com/azure/cost-management-billing/costs/cost-mgt-alerts-monitor-usage-spending)
