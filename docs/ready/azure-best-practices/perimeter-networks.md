...
- [Общедоступные IP-адреса.][public-ip]
 ...
 *рис. 1. Пример топологии сети с центральным и периферийным портом.*
