...
- **Разделение проблем.** Вы можете развертывать отдельные рабочие нагрузки между центральными ИТ-командами и командами по выполнению рабочих нагрузок.
...
*Рис. 1. Пример топологии сети концентратора и периферийной зоны.*
...
*Рисунок 3. периферийные серверы, соединяющие друг с другом и концентратор.*
