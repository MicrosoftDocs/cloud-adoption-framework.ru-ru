...
Вы также можете рассмотреть реализации сторонних производителей. У наших партнеров есть множество реализаций, доступных в службах. Дополнительные сведения см. [в статье Оценка целевой зоны Azure для партнера Майкрософт](./partner-landing-zone.md).
...
:::row:::
    ...
    :::column-end:::
    :::column:::
        [Согласование операционной модели](../../operating-model/compare.md#operating-model-comparison)
    :::column-end:::
    :::column:::
...
Дополнительные сведения о типах операций см. в статье [Сравнение общих облачных рабочих моделей](../../operating-model/compare.md).
...
Если вы запускаете небольшие и развернутые, есть способы суффиЦиенци, скорости внедрения и оперативного освоения. Используйте методологии управления, а также управляйте ими в облачной инфраструктуре внедрения, чтобы итеративно встраивать эти компоненты в решение "Целевая зона". Для итеративного совершенствования проекта используйте восемь областей проектирования, [рекомендации по проектированию инфраструктуры корпоративного внедрения в масштабах предприятия](../enterprise-scale/design-guidelines.md).

Дополнительные сведения об эффективности работы см. в статье [Доставка в эксплуатацию во время цифрового преобразования](../../get-started/operational-excellence.md).
...
Запуск Small и Expand является итеративным подходом к соответствию. Инфраструктура внедрения в облаке управляет методологией и управляет ими для поддержки важных данных или важных рабочих нагрузок. Дополнительные сведения см. в разделе Управление [методологией для облачных](../../govern/methodology.md) и [ИТ управления и эксплуатации в облаке](../../manage/considerations/index.md).

Архитектура корпоративного уровня включает в себя проектирование сегментации и разделения для поддержки целей обеспечения соответствия требованиям и [платформы включения службы](../enterprise-scale/security-governance-and-compliance.md#service-enablement-framework) , чтобы определить, как добиться соответствующих уровней управления, безопасности и соответствия требованиям.
...
Дополнительные сведения см. в статье рекомендации [по обеспечению готовности к использованию в Azure](../azure-best-practices/index.md).
...
- [Схема CAF Foundation](./foundation-blueprint.md)
- [Схема зоны размещения для миграции в соответствии с CAF](./migrate-landing-zone.md)
