...
Затем мы указываем имя log Analytics и набор решений для анализа развертывания. Здесь мы сохранили мониторинг сети, Оценка Active Directory и репликацию, Аналитика DNS и Аналитика Key Vault.
