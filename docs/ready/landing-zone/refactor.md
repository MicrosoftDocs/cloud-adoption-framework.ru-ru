...
В качестве примера создания рефакторинга снятие позволяет сравнить подход к разработке в предыдущем примере и схему целевой зоны миграции каф.

- В соответствии с [сведениями о предположениях схемы КАФ миграции на главную зону](./migrate-landing-zone.md#assumptions)Эта начальная зона не предназначена для конфиденциальных данных или критически важных рабочих нагрузок. Эти функции необходимо добавить с помощью рефакторинга.
