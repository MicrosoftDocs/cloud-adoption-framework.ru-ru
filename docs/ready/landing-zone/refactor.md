...
Оба основных блока блокирования основаны на том, что облачная среда и существующие центры обработки данных должны находиться в зависимости от особенностей операций, управления и безопасности. Это очень долгосрочная цель. Тем не менее, это происходит из детальная баланса между временем достижения этой цели и скоростью, необходимой для предоставления бизнес-результатов.
