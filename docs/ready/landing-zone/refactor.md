...
Концепция рефакторинга целевой зоны проста, но для выполнения требуется надлежащее снятие. Описанная выше концепция описывает базовый поток:
