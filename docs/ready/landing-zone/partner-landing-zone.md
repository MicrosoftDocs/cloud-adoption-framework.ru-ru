...
Облачная инфраструктура внедрения применяет внедрение облачных технологий в качестве действия самообслуживания. Цель состоит в том, чтобы предоставить каждой команде возможность перехода с помощью стандартизованных подходов. На практике вы не можете предположить, что самостоятельный подход достаточно для всех действий по внедрению.
...
В этой статье представлен ряд вопросов, которые помогут создать представление о области предложения целевой зоны Azure партнера.
