...
В Azure предоставляются четыре уровня области управления: группы управления, подписки, группы ресурсов и ресурсы. На рисунке ниже показаны связи между этими уровнями.
   ...
   ![Схема со связями уровней иерархии управления](./media/organize-resources/scope-levels.png)
...
- **Оптимизация затрат:** вы можете выделить ресурсы для команд и ресурсов, ответственных за затраты. В службе "Управление затратами Azure" и функции выставления счетов можно применить тег "место возникновения затрат" в качестве фильтра, чтобы сообщить о расходах на основе использования группы или отдела.
