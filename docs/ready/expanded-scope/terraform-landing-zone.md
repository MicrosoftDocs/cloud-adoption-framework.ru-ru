...
|Хранилище|Недоступно|[Рекомендации по выбору службы хранилища Azure](../considerations/storage-options.md) |
...
| Имя тега | Description (Описание) | Ключ | Пример значения |
|--|--|--|--|
...
| Version (версия) | Версия развернутой схемы. | версия | Версия 0,1 |
...
В будущих эталонных архитектурах эта концепция будет продемонстрирована для топологии типа "звезда".
