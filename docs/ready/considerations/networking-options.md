...
Для организаций, удовлетворяющих следующим критериям, также может потребоваться начать с [целевой зоны КАФ корпоративного масштаба](../../ready/enterprise-scale/index.md).
