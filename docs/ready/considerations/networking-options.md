...
- Необходимо поддерживать общую политику и соответствие нормативным требованиям, а также централизованно управлять основными службами.
