...
| Я хочу оптимизировать доставку из ферм серверов приложений, повышая безопасность приложений с помощью брандмауэра веб-приложения. | [Шлюз приложений Azure](https://docs.microsoft.com/azure/application-gateway) <br> [Azure Front Door Service](https://docs.microsoft.com/azure/frontdoor) |
...
| Мне нужно защитить приложения Azure от DDoS-атак. | [Защита от атак DDoS в Azure](https://docs.microsoft.com/azure/virtual-network/ddos-protection-overview) |
...
- Необходимо включить гибкие возможности развертывания для рабочих нагрузок, чтобы обеспечить поддержку групп разработчиков и эксплуатации, сохраняя общую политику и соответствие нормативным требованиям, а также централизованное управление основными службами.
