...
- **Если вы перемещаете существующие рабочие нагрузки, могут ли они воспользоваться преимуществами современных облачных технологий?** Миграция локальных рабочих нагрузок требует анализа: можно ли легко оптимизировать существующие приложения и службы, чтобы воспользоваться преимуществами современных облачных технологий, или же подход с приближением *и сдвигом* лучше подходит для рабочих нагрузок?
