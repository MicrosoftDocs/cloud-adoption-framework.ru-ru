...
ms.locfileid: "81121705"
---
# <a name="test-driven-development-tdd-for-landing-zones"></a>Разработка на основе тестирования (TDD) для начальных зон
...
## <a name="definition-of-done"></a>Определение завершено
...
- **Создание теста:** Определите тест, чтобы убедиться, что выполнены условия приемки для определенной функции добавления значения. По возможности автоматизируйте тест.
...
- Эта среда должна рассматриваться как "демилитаризованная зона" с доступом к общедоступному Интернету.
...
Последняя точка выше не является ни функцией, ни критерием приемки. Однако это индикатор того, что требуются дополнительные расширения, и их следует изучить с другими группами на ранних этапах.

## <a name="additional-examples-of-a-definition-of-done"></a>Дополнительные примеры определения Done

Методология управления в инфраструктуре внедрения облачных технологий обеспечивает более подробное руководство по естественной зрелости группы управления. В этом пути есть несколько примеров "определение завершенности" и "условия приемки" в форме операторов политики.
