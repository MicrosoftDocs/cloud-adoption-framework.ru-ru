...
- [Вычисление решений](./compute-options.md). чтобы максимально упростить работу, выровняйте параметры вычислений с целью целевой зоны. Это решение можно реализовать с помощью цепочек инструментов автоматизации, таких как инициатива политики Azure и целевые зоны.
