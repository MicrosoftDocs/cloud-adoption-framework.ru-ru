...
| Мне нужно оптимально распределять трафик между службами в регионах Azure по всему миру, обеспечивая при этом высокую доступность и быстроту отклика. | [Azure Traffic Manager](https://docs.microsoft.com/azure/traffic-manager)<br/>[Azure Front Door Service](https://docs.microsoft.com/azure/frontdoor) |
...
| Мне нужны собственные возможности брандмауэра со встроенной высокой доступностью, неограниченной облачной масштабируемостью и отсутствием необходимости обслуживания. | [Брандмауэр Azure](https://docs.microsoft.com/azure/firewall) |
