...
- Убедитесь, что только привилегированные пользователи могут управлять группами управления в клиенте, включив авторизацию RBAC Azure в параметрах иерархии группы управления.
