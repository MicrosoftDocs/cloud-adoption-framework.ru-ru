...
ms.subservice: ready
ms.openlocfilehash: ae309437e0ad51122a091bfb68882b7d7bad64dd
ms.sourcegitcommit: bd815dee6d60812979d3700ee676411eb0281071
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/12/2020
ms.locfileid: "88143028"
---
...
- Виртуальная глобальная сеть значительно упрощает сквозное сетевое подключение в Azure и распределенной среде, создавая [архитектуру сети и периферийную сеть](https://docs.microsoft.com/azure/virtual-wan/virtual-wan-global-transit-network-architecture) , охватывающую несколько регионов Azure и локальных расположений (любое подключение к любому), как показано на рисунке ниже.
...
- Для сценариев серия статей Brownfield, в которых выполняется миграция из концентратора и топологии периферийной сети, не основанной на виртуальной глобальной сети, см. статью [Миграция в виртуальную глобальную сеть Azure](https://docs.microsoft.com/azure/virtual-wan/migrate-from-hub-spoke-topology).
...
- Различные сетевые топологии могут подключаться к нескольким виртуальных сетей зонам: одной крупной плоской виртуальной сети, нескольким виртуальных сетей, подключенным к нескольким каналам ExpressRoute или подключениям, концентратору, периферийной, полной сети и гибридной.
...
- В следующих сценариях следует учитывать архитектуру сети в топологии концентратора и периферийной сети с технологиями, отличными от виртуальных сетей WAN.
...
- Для региональных развертываний в основном используется топология HUB и спица с основными зонами, виртуальных сетей подключение с помощью пиринга виртуальных сетей к центральной виртуальной сети для распределенного подключения через ExpressRoute, VPN для подключения филиалов, периферийного подключения через NVA и определяемые пользователем маршруты, а также сетевая защита через NVA, как показано на рисунке ниже.

![Топология сети и возможности подключения](./media/hub-and-spoke-topology.png)

_Рис. 5. топология сети концентратора и звезды._
