...
- Не создавайте транзитную сеть поверх виртуальной глобальной сети Azure. Виртуальная глобальная сеть удовлетворяет всем требованиям к топологии транзитной сети, включая возможность использовать сторонние NVA. Создание транзитной сети поверх виртуальной глобальной сети Azure будет избыточным и повысить сложность. 
