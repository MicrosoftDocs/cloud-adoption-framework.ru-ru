...
|---|---|---|---|
| Владелец платформы Azure (т. е. Встроенная роль владельца)               | Управление жизненным циклом группы управления и подписки                                                           | `*`                                                                                                                                                                                                                  |                                                                                                                                                                                         |
