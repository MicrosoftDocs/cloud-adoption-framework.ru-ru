...
Управление удостоверениями и доступом (IAM) — это безопасность границ в общедоступном облаке, которая должна рассматриваться как основа любой безопасной и полностью совместимой архитектуры общедоступного облака. Microsoft Azure предлагает исчерпывающий набор служб, средств и эталонных архитектур, позволяющих организациям создавать Высокобезопасные и ресурсоемкие среды, а также их описание.
...
Корпоративные организации обычно используют подход с минимальными правами доступа к рабочему доступу, и эта модель должна быть расширена для использования Azure с помощью управления доступом на основе ролей (RBAC) Azure AD и определений пользовательских ролей. Очень важно спланировать, как управлять доступом к ресурсам в Azure на уровне управления и плоскости данных. Любой проект для IAM и RBAC должен соответствовать нормативным требованиям, безопасности и эксплуатационным требованиям, прежде чем его можно будет принять.
