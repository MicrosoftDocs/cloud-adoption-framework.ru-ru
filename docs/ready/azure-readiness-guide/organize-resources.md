...
- [Scaling with multiple Azure subscriptions](../considerations/scaling-subscriptions.md) (Масштабирование с помощью нескольких подписок Azure)
- [Resource access management in Azure](../../governance/resource-consistency/azure-resource-access.md) (Управление доступом к ресурсам в Azure)
...
Дополнительные рекомендации и примеры тегов можно найти в [руководстве по использованию тегов](../considerations/name-and-tag.md) для Cloud Adoption Framework.
