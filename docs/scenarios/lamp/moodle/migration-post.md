...
Разрешения Moodle и мудледата могут быть неправильными, если отображается эта ошибка: `fatal error: $cfg->dataroot is not writable. The admin has to fix directory permissions! Exiting.`
