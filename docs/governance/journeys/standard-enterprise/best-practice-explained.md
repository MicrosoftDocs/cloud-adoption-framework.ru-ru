...
- Группы ресурсов создаются для приложений, использующих жизненный цикл: все, что создано вместе, поддерживаются вместе, и их работа может находиться в одной группе ресурсов.
...
> [Улучшение специализации в плане безопасности](./security-baseline-evolution.md)
