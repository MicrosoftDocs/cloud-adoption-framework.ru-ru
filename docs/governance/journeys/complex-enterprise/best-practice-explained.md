...
Решения для ведения журналов и создания отчетов определяют структуру данных журнала магазина и средства мониторинга и создания отчетов, которые сообщают ИТ-специалистам об операционной работоспособности. В этом заведении мы предлагаем шаблон **[гибридного мониторинга](../../../decision-guides/log-and-report/index.md)** для ведения журналов и создания отчетов, но не требуется команда разработчиков на этом этапе.
...
- [шаблоны ведения журналов и создания отчетов](../../../decision-guides/log-and-report/index.md);
...
После того как это руководство будет реализовано, каждая команда внедрения облачной среды может продолжить работу, имея прочную базу системы управления. Группа управления облаком будет работать параллельно, чтобы постоянно обновлять корпоративные политики и дисциплины управления.
...
> [Повышение дисциплины базовых показателей идентификаторов](./identity-baseline-evolution.md)
