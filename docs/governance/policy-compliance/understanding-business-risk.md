...
- Все активы могут быть прерваны (через ошибку, по ошибке или по обслуживанию).
- Все активы подвергаются риску создания слишком больших затрат.
- Все активы могут быть скомпрометированы ненадежными паролями.
- Любой ресурс со всеми открытыми портами, предоставляемыми в Интернете, подвержен риску компрометации.
