...
- **Проектирование или техническое руководство:** Практические рекомендации, спецификации или другие руководства для поддержки и применения этой политики, которую ИТ-специалисты и разработчики могут использовать при разработке и создании развертываний в облаке.
...
> [Соответствие руководства по проектированию руководства корпоративным политикам](./align-governance-journeys.md)
