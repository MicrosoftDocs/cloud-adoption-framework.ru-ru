...
| [Повышение безопасности зоны размещения](../ready/considerations/landing-zone-security.md)                       | **Новая статья:** Общие сведения о рекомендациях в этом разделе, связанных с циклом TDD. |
