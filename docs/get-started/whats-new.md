...
Новая [страница Обзор сценариев миграции](../scenarios/index.md) основана на методологии миграции каф, чтобы продемонстрировать, как Azure доставляется в обещании "#OneMigrate". Он предоставляет подходы к переносу нескольких первых и сторонних сценариев в Azure. Сюда входят три новых сценария миграции:
...
### <a name="analytics-in-caf"></a>Аналитика в КАФ
Решения аналитики теперь включены в платформу внедрения Microsoft Cloud. В этих новых статьях приведены рекомендации по включению решений аналитики в процессе внедрения в облако.
...
### <a name="ai-in-caf"></a>AI в КАФ
Решения искусственного интеллекта (ии) и рекомендации теперь интегрированы в платформу внедрения Microsoft Cloud. Эти решения искусственного интеллекта могут помочь в ускорении инноваций с прогнозированием потребностей клиентов, автоматизации бизнес-процессов, обнаружении информации, поиске новых способов общения с клиентами и предоставления лучшего опыта в процессе внедрения в облако.
...
| [Инновации с использованием ИИ](../innovate/best-practices/predict.md) | Узнайте о решениях искусственного интеллекта (Машинное обучение, приложениях и агентах ии, интеллектуальном анализе знаний) и рекомендациях, которые могут ускорить цифровое Invention. | 
...
| [Начало работы с Cloud Adoption Framework](./index.md) | Начните с этого руководства, чтобы выбрать руководство по началу работы, которое соответствует целям внедрения в облаке. Эти распространенные сценарии предполагают использование Microsoft Cloud Adoption Framework для Azure. |
...
| Обновленное оглавление | Оглавление для руководств по миграции Azure и улучшения процессов были обновлены в соответствии с изменениями методологии. |
