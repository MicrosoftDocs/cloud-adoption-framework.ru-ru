...
Официальное руководство по облачной инфраструктуре внедрения для Azure — всегда создавать группу управления облаком. Сначала группа может быть незначительной. Независимо от его размера, его роль будет важна. Если команда не нужна, группа или пользователь в существующей группе перехода должны согласиться с соблюдением обязанностей, связанных с [функциями управления облаком](../../organize/cloud-governance.md).

**Результатам**

- Определите, нужна ли вам группа по управлению облаком.
- Задокументируйте решение и ответственных лиц в [шаблоне RACI (ответственный, учетный, проконсультироваться и обучится)](https://archcenter.blob.core.windows.net/cdn/fusion/management/raci-template.xlsx) , выбрав вкладку **Выравнивание Организации** .
...
- Дополнительные рекомендации по использованию ритмичностей для собраний см. в разделе "Доставка" [функций управления облаком](../../organize/cloud-governance.md#deliverable).
...
- Выполните оценку производительности управления, которая основана на взаимодействиях с различными заинтересованными лицами. Или попросите других команд выполнить оценку самостоятельно.

**Рекомендации по поддержке готовности к завершению.**

- Оцените свои потребности и приоритеты управления, используя [Контрольный тест](../../govern/benchmark.md)для управления.
