...
Эти руководства по началу работы содержат рекомендации для различных групп, а также их различные степени ответственности. Используйте руководства, чтобы понять, как ваша команда размещается в оставшейся части пути. Также используйте их, чтобы понять уровни поддержки, которые можно получить от компании.
