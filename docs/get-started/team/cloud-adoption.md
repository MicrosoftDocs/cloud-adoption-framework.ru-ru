...
- Обновите шаблон компании [RACI (ответственный, отвечающий, проконсультироваться и](../../organize/raci-alignment.md) обновим), чтобы помочь другим пользователям понять, кто работает над группой, и какую методику, которую Группа будет сосредоточиться на своей реализации.
...
В зависимости от типа группы перехода, членом которой вы являетесь, вы сможете начать работу с одним из следующих путей:

- Начало работы. Перенос рабочих нагрузок в облако
- Начало работы: создание новых продуктов или услуг

В каждом из этих руководств по началу работы вы найдете рекомендации для различных групп, а также их различные степени ответственности. Используйте руководства, чтобы понять, как ваша команда размещается в оставшейся части пути. Также используйте их, чтобы понять уровни поддержки, которые можно получить от компании.
...
| Команда, подучетная запись | Ответственные и вспомогательные команды |
| --- | --- |
| <li> Группа по внедрению облака | <li> Группа по системе управления облаком <li> Группа по эксплуатации облака <li> Облачный центр для ИТ и централизованного ИТ <li> Группа по облачной стратегии |
