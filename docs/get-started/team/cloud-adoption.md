...
- Выровняйте обязанности между командами, разработав межкомандную матрицу, которая определяет _ответственных, осведомленных, проконсультируйтесь и информированные (RACI)_ стороны. Обновите [шаблон RACI](../../organize/raci-alignment.md) компании, чтобы помочь другим пользователям понять, кто работает над группой, и какую методологию она может сосредоточиться.
