...
Технические усилия и процесс, необходимые для миграции рабочих нагрузок, относительно просты. Очень важно выполнить процесс миграции эффективно. Но стратегическая готовность к миграции еще больше влияет на временные шкалы и успешное завершение общей миграции.
...
- Разработайте план для рефакторинга с помощью облачного центра.
- Риски временной шкалы:
...
- Риски временной шкалы:
  ...
  - Выполните оценку проверки архитектуры Azure: Оценка за один час для каждого приложения.
