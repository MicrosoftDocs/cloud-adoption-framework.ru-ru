...
Для создания новых продуктов и служб в облаке требуется другой подход, нежели при миграции. Методология внедрения платформы облачных технологий для Azure создает подход, который помогает разрабатывать новые продукты и службы.
