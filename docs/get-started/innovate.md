...
Для поддержки разработки стратегии внедрения инноваций модель искусственного интеллекта — это бесплатное средство, помогающее организациям оценивать свои возможности создания и использования систем на основе искусственного интеллекта. Существует четыре уровня зрелости: базовый, подходный, мотивирующее и зрелый. Каждый из этих уровней зрелости включает определенный набор характеристик, позволяющий определить способность Организации принимать определенные типы решений искусственного интеллекта, устранять связанные с ними риски и реализовывать стратегии. Оценка занимает 5-10 минут и измеряет возможности Организации в четырех категориях: стратегия, язык и региональные параметры, организационные характеристики и возможности. Измеряя возможности, мы можем вычислить оценку вашей организации и предоставить оценку использования ИСКУССТВЕНного инноваций в виде кривой.

Используйте [модель зрелости искусственного интеллекта](https://aiready.microsoft.com) , чтобы оценить готовность Организации к созданию систем на основе искусственного интеллекта. После завершения оценки вы оцените оценку состояния зрелости ИСКУССТВЕНных инноваций.
...
Для поддержки разработки стратегии внедрения инноваций модель искусственного интеллекта — это бесплатное средство, которое помогает организациям оценивать свои возможности создания и использования систем на основе искусственного интеллекта. Существует четыре уровня зрелости, которые включают в себя фундамент, подход, мотивирующее и зрелый. Каждый из этих уровней зрелости включает конкретный набор характеристик, позволяющий определить способность Организации принимать определенные типы решений искусственного интеллекта, связанные риски и стратегии. Оценка занимает 5-10 минут и измеряет возможности вашей организации в четырех категориях: стратегия, язык и региональные параметры, организационные характеристики и возможности.  Измеряя эти показатели, мы можем вычислить оценку вашей организации и предоставить оценку зрелости инноваций на базе искусственного интеллекта на кривой.
...
- После завершения оценки выходные данные средства будут предоставлять оценку с оценкой состояния зрелости искусственного интеллекта.
