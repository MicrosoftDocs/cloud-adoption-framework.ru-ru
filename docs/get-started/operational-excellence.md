...
В эксплуатацию требуется подход, оптимизированный для обеспечения надежности, производительности, безопасности и оптимизации затрат. Используйте оставшиеся рекомендации в этой серии, чтобы обеспечить реализацию каждого из этих принципов с помощью единообразных подходов к автоматизации.
