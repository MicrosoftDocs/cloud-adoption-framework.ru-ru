...
Дополнительные сведения см. в разделе [Обнаружение и классификация критически важных для бизнеса приложений](/azure/architecture/framework/security/design-apps-services#identify-and-classify-business-critical-applications).
...
- Ознакомьтесь со средствами и службами безопасности Azure в [службах безопасности и технологиях, доступных в Azure](/azure/security/fundamentals/services-technologies).
