...
Узнайте, как [использовать шаблон результата бизнеса](./how-to-use-the-business-outcome-template.md).

> [!div class="nextstepaction"]
> [Использование шаблона результата бизнеса](./how-to-use-the-business-outcome-template.md)
